...
{
    // PS_TOUCH_SCRN_COD
    public class PsTouchScrnCod
    {
        public string TouchScrnCod { get; set; } // TOUCH_SCRN_COD (Primary key) (length: 10)
        ...
        public string ScrnConfig { get; set; } // SCRN_CONFIG (length: 2147483647)
