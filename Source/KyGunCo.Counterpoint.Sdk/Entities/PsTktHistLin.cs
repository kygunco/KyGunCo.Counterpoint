...
namespace KyGunCo.Counterpoint.Sdk.Entities
{
    ...
    public class PsTktHistLin
    {
        ...
        public string IsScrapRetLin { get; set; } = "N"; // IS_SCRAP_RET_LIN (length: 1)
        ...
        /// <summary>
        /// Child PsTktHistDiscs where [PS_TKT_HIST_DISC].([BUS_DAT], [DOC_ID], [LIN_SEQ_NO]) point to this entity (FK_PS_TKT_HIST_DISC_PS_TKT_HIST_LIN)
        /// </summary>
        public virtual IList<PsTktHistDisc> PsTktHistDiscs { get; set; } = new List<PsTktHistDisc>(); // PS_TKT_HIST_DISC.FK_PS_TKT_HIST_DISC_PS_TKT_HIST_LIN

        /// <summary>
        /// Child PsTktHistLinCells where [PS_TKT_HIST_LIN_CELL].([BUS_DAT], [DOC_ID], [LIN_SEQ_NO]) point to this entity (FK_PS_TKT_HIST_LIN_CELL_PS_TKT_HIST_LIN)
        /// </summary>
        public virtual IList<PsTktHistLinCell> PsTktHistLinCells { get; set; } = new List<PsTktHistLinCell>(); // PS_TKT_HIST_LIN_CELL.FK_PS_TKT_HIST_LIN_CELL_PS_TKT_HIST_LIN

        /// <summary>
        /// Child PsTktHistLinPrices where [PS_TKT_HIST_LIN_PRICE].([BUS_DAT], [DOC_ID], [LIN_SEQ_NO]) point to this entity (FK_PS_TKT_HIST_LIN_PRICE_PS_TKT_HIST_LIN)
        /// </summary>
        public virtual IList<PsTktHistLinPrice> PsTktHistLinPrices { get; set; } = new List<PsTktHistLinPrice>(); // PS_TKT_HIST_LIN_PRICE.FK_PS_TKT_HIST_LIN_PRICE_PS_TKT_HIST_LIN

        /// <summary>
        /// Child PsTktHistLinPrompts where [PS_TKT_HIST_LIN_PROMPT].([BUS_DAT], [DOC_ID], [LIN_SEQ_NO]) point to this entity (FK_PS_TKT_HIST_LIN_PROMPT_PS_TKT_HIST_LIN)
        /// </summary>
        public virtual IList<PsTktHistLinPrompt> PsTktHistLinPrompts { get; set; } = new List<PsTktHistLinPrompt>(); // PS_TKT_HIST_LIN_PROMPT.FK_PS_TKT_HIST_LIN_PROMPT_PS_TKT_HIST_LIN

        /// <summary>
        /// Child PsTktHistLinSers where [PS_TKT_HIST_LIN_SER].([BUS_DAT], [DOC_ID], [LIN_SEQ_NO]) point to this entity (FK_PS_TKT_HIST_LIN_SER_PS_TKT_HIST_LIN)
        /// </summary>
        public virtual IList<PsTktHistLinSer> PsTktHistLinSers { get; set; } = new List<PsTktHistLinSer>(); // PS_TKT_HIST_LIN_SER.FK_PS_TKT_HIST_LIN_SER_PS_TKT_HIST_LIN

        /// <summary>
        /// Parent (One-to-One) PsTktHistLin pointed by [PS_TKT_HIST_LIN_EXT].([BUS_DAT_EXT], [DOC_ID_EXT], [LIN_SEQ_NO_EXT]) (FK_PS_TKT_HIST_LIN_EXT_PS_TKT_HIST_LIN)
        /// </summary>
        public virtual PsTktHistLinExt PsTktHistLinExt { get; set; } // PS_TKT_HIST_LIN_EXT.FK_PS_TKT_HIST_LIN_EXT_PS_TKT_HIST_LIN

        /// <summary>
        /// Parent (One-to-One) PsTktHistLin pointed by [PS_TKT_HIST_LIN_KIT].([BUS_DAT], [DOC_ID], [LIN_SEQ_NO]) (FK_PS_TKT_HIST_LIN_KIT_PS_TKT_HIST_LIN)
        /// </summary>
        public virtual PsTktHistLinKit PsTktHistLinKit { get; set; } // PS_TKT_HIST_LIN_KIT.FK_PS_TKT_HIST_LIN_KIT_PS_TKT_HIST_LIN

        /// <summary>
        /// Parent (One-to-One) PsTktHistLin pointed by [PS_TKT_HIST_LIN_LOY].([BUS_DAT], [DOC_ID], [LIN_SEQ_NO]) (FK_PS_TKT_HIST_LIN_LOY_PS_TKT_HIST_LIN)
        /// </summary>
        public virtual PsTktHistLinLoy PsTktHistLinLoy { get; set; } // PS_TKT_HIST_LIN_LOY.FK_PS_TKT_HIST_LIN_LOY_PS_TKT_HIST_LIN

        /// <summary>
        /// Parent (One-to-One) PsTktHistLin pointed by [PS_TKT_HIST_LIN_PO].([BUS_DAT], [DOC_ID], [LIN_SEQ_NO]) (FK_PS_TKT_HIST_LIN_PO_PS_TKT_HIST_LIN)
        /// </summary>
        public virtual PsTktHistLinPo PsTktHistLinPo { get; set; } // PS_TKT_HIST_LIN_PO.FK_PS_TKT_HIST_LIN_PO_PS_TKT_HIST_LIN

        // Foreign keys

        /// <summary>
        /// Parent PsTktHist pointed by [PS_TKT_HIST_LIN].([BusDat], [DocId]) (FK_PS_TKT_HIST_LIN_PS_TKT_HIST)
        /// </summary>
        public virtual PsTktHist PsTktHist { get; set; } // FK_PS_TKT_HIST_LIN_PS_TKT_HIST
    }
