...
namespace KyGunCo.Counterpoint.Sdk.Entities
{
    ...
    public class PoAdjHdr
    {
        ...
        /// <summary>
        /// Child PoAdjLins where [PO_ADJ_LIN].[RECVR_NO] point to this entity (FK_PO_ADJ_LIN_PO_ADJ_HDR)
        /// </summary>
        public virtual IList<PoAdjLin> PoAdjLins { get; set; } = new List<PoAdjLin>(); // PO_ADJ_LIN.FK_PO_ADJ_LIN_PO_ADJ_HDR

        /// <summary>
        /// Child PoAdjNotes where [PO_ADJ_NOTE].[RECVR_NO] point to this entity (FK_PO_ADJ_NOTE_PO_ADJ_HDR)
        /// </summary>
        public virtual IList<PoAdjNote> PoAdjNotes { get; set; } = new List<PoAdjNote>(); // PO_ADJ_NOTE.FK_PO_ADJ_NOTE_PO_ADJ_HDR

        /// <summary>
        /// Child PoAdjTaxes where [PO_ADJ_TAX].[RECVR_NO] point to this entity (FK_PO_ADJ_TAX_PO_ADJ_HDR)
        /// </summary>
        public virtual IList<PoAdjTax> PoAdjTaxes { get; set; } = new List<PoAdjTax>(); // PO_ADJ_TAX.FK_PO_ADJ_TAX_PO_ADJ_HDR

        // Foreign keys

        /// <summary>
        /// Parent ArTaxCod pointed by [PO_ADJ_HDR].([TaxCod]) (FK_PO_ADJ_HDR_AR_TAX_COD)
        /// </summary>
        public virtual ArTaxCod ArTaxCod { get; set; } // FK_PO_ADJ_HDR_AR_TAX_COD

        /// <summary>
        /// Parent ImLoc pointed by [PO_ADJ_HDR].([RecvrLocId]) (FK_PO_ADJ_HDR_IM_LOC)
        /// </summary>
        public virtual ImLoc ImLoc { get; set; } // FK_PO_ADJ_HDR_IM_LOC
    }
