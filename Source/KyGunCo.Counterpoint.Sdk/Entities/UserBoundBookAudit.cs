...
namespace KyGunCo.Counterpoint.Sdk.Entities
{
    ...
    public class UserBoundBookAudit
    {
        public int AuditSeqNo { get; set; } // AUDIT_SEQ_NO (Primary key)
        public string AuditAction { get; set; } // AUDIT_ACTION (length: 30)
        public DateTime? AuditDt { get; set; } // AUDIT_DT
        public string AcqDocNo { get; set; } // ACQ_DOC_NO (length: 15)
        ...
        public int? BoundBookPageNo { get; set; } // BOUND_BOOK_PAGE_NO
        public int? BoundBookPageSeqNo { get; set; } // BOUND_BOOK_PAGE_SEQ_NO
        public int? BoundBookLocSeqNo { get; set; } // BOUND_BOOK_LOC_SEQ_NO
        public string BoundBookType { get; set; } // BOUND_BOOK_TYPE (length: 30)
        ...
        public string ChangeType { get; set; } // CHANGE_TYPE (length: 1)
