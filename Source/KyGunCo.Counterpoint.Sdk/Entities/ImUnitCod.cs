...
{
    // IM_UNIT_COD
    public class ImUnitCod
    {
        public string Unit { get; set; } // UNIT (Primary key) (length: 15)
        public string Descr { get; set; } // DESCR (length: 30)
        public string DescrUpr { get; set; } // DESCR_UPR (length: 30)
        public decimal? DfltNumer { get; set; } // DFLT_NUMER
        public decimal? DfltDenom { get; set; } // DFLT_DENOM
