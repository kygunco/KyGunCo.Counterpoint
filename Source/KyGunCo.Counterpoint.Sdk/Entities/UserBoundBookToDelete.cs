...
namespace KyGunCo.Counterpoint.Sdk.Entities
{
    ...
    public class UserBoundBookToDelete
    {
        ...
        public string Descr { get; set; } // DESCR (Primary key) (length: 30)
        ...
        public string LstUpdateUsrId { get; set; } // LST_UPDATE_USR_ID (Primary key) (length: 10)
