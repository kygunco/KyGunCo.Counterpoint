...
namespace KyGunCo.Counterpoint.Sdk.Entities
{
    ...
    public class PsLwyHistAuditLogTot
    {
        ...
        public string TotTyp { get; set; } = "L"; // TOT_TYP (Primary key) (length: 1)
        ...
        /// <summary>
        /// Parent PsLwyHistAuditLog pointed by [PS_LWY_HIST_AUDIT_LOG_TOT].([BusDat], [DocId], [LogSeqNo]) (FK_PS_LWY_HIST_AUDIT_LOG_TOT_PS_LWY_HIST_AUDIT_LOG)
        /// </summary>
        public virtual PsLwyHistAuditLog PsLwyHistAuditLog { get; set; } // FK_PS_LWY_HIST_AUDIT_LOG_TOT_PS_LWY_HIST_AUDIT_LOG
    }
