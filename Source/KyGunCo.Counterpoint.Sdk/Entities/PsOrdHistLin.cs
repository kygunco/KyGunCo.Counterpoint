...
namespace KyGunCo.Counterpoint.Sdk.Entities
{
    ...
    public class PsOrdHistLin
    {
        ...
        /// <summary>
        /// Child PsOrdHistDiscs where [PS_ORD_HIST_DISC].([BUS_DAT], [DOC_ID], [LIN_SEQ_NO]) point to this entity (FK_PS_ORD_HIST_DISC_PS_ORD_HIST_LIN)
        /// </summary>
        public virtual IList<PsOrdHistDisc> PsOrdHistDiscs { get; set; } = new List<PsOrdHistDisc>(); // PS_ORD_HIST_DISC.FK_PS_ORD_HIST_DISC_PS_ORD_HIST_LIN

        /// <summary>
        /// Child PsOrdHistLinCells where [PS_ORD_HIST_LIN_CELL].([BUS_DAT], [DOC_ID], [LIN_SEQ_NO]) point to this entity (FK_PS_ORD_HIST_LIN_CELL_PS_ORD_HIST_LIN)
        /// </summary>
        public virtual IList<PsOrdHistLinCell> PsOrdHistLinCells { get; set; } = new List<PsOrdHistLinCell>(); // PS_ORD_HIST_LIN_CELL.FK_PS_ORD_HIST_LIN_CELL_PS_ORD_HIST_LIN

        /// <summary>
        /// Child PsOrdHistLinPrices where [PS_ORD_HIST_LIN_PRICE].([BUS_DAT], [DOC_ID], [LIN_SEQ_NO]) point to this entity (FK_PS_ORD_HIST_LIN_PRICE_PS_ORD_HIST_LIN)
        /// </summary>
        public virtual IList<PsOrdHistLinPrice> PsOrdHistLinPrices { get; set; } = new List<PsOrdHistLinPrice>(); // PS_ORD_HIST_LIN_PRICE.FK_PS_ORD_HIST_LIN_PRICE_PS_ORD_HIST_LIN

        /// <summary>
        /// Child PsOrdHistLinPrompts where [PS_ORD_HIST_LIN_PROMPT].([BUS_DAT], [DOC_ID], [LIN_SEQ_NO]) point to this entity (FK_PS_ORD_HIST_LIN_PROMPT_PS_ORD_HIST_LIN)
        /// </summary>
        public virtual IList<PsOrdHistLinPrompt> PsOrdHistLinPrompts { get; set; } = new List<PsOrdHistLinPrompt>(); // PS_ORD_HIST_LIN_PROMPT.FK_PS_ORD_HIST_LIN_PROMPT_PS_ORD_HIST_LIN

        /// <summary>
        /// Child PsOrdHistLinSers where [PS_ORD_HIST_LIN_SER].([BUS_DAT], [DOC_ID], [LIN_SEQ_NO]) point to this entity (FK_PS_ORD_HIST_LIN_SER_PS_ORD_HIST_LIN)
        /// </summary>
        public virtual IList<PsOrdHistLinSer> PsOrdHistLinSers { get; set; } = new List<PsOrdHistLinSer>(); // PS_ORD_HIST_LIN_SER.FK_PS_ORD_HIST_LIN_SER_PS_ORD_HIST_LIN

        /// <summary>
        /// Parent (One-to-One) PsOrdHistLin pointed by [PS_ORD_HIST_LIN_EXT].([BUS_DAT_EXT], [DOC_ID_EXT], [LIN_SEQ_NO_EXT]) (FK_PS_ORD_HIST_LIN_EXT_PS_ORD_HIST_LIN)
        /// </summary>
        public virtual PsOrdHistLinExt PsOrdHistLinExt { get; set; } // PS_ORD_HIST_LIN_EXT.FK_PS_ORD_HIST_LIN_EXT_PS_ORD_HIST_LIN

        /// <summary>
        /// Parent (One-to-One) PsOrdHistLin pointed by [PS_ORD_HIST_LIN_KIT].([BUS_DAT], [DOC_ID], [LIN_SEQ_NO]) (FK_PS_ORD_HIST_LIN_KIT_PS_ORD_HIST_LIN)
        /// </summary>
        public virtual PsOrdHistLinKit PsOrdHistLinKit { get; set; } // PS_ORD_HIST_LIN_KIT.FK_PS_ORD_HIST_LIN_KIT_PS_ORD_HIST_LIN

        /// <summary>
        /// Parent (One-to-One) PsOrdHistLin pointed by [PS_ORD_HIST_LIN_PO].([BUS_DAT], [DOC_ID], [LIN_SEQ_NO]) (FK_PS_ORD_HIST_LIN_PO_PS_ORD_HIST_LIN)
        /// </summary>
        public virtual PsOrdHistLinPo PsOrdHistLinPo { get; set; } // PS_ORD_HIST_LIN_PO.FK_PS_ORD_HIST_LIN_PO_PS_ORD_HIST_LIN

        // Foreign keys

        /// <summary>
        /// Parent PsOrdHist pointed by [PS_ORD_HIST_LIN].([BusDat], [DocId]) (FK_PS_ORD_HIST_LIN_PS_ORD_HIST)
        /// </summary>
        public virtual PsOrdHist PsOrdHist { get; set; } // FK_PS_ORD_HIST_LIN_PS_ORD_HIST
    }
