...
namespace KyGunCo.Counterpoint.Sdk.Entities
{
    ...
    public class UserImSerHist
    {
        ...
        public string Stat { get; set; } // STAT (Primary key) (length: 1)
        public string PrevStat { get; set; } = "!"; // PREV_STAT (Primary key) (length: 1)
        ...
        public string ManEntd { get; set; } = "N"; // MAN_ENTD (Primary key) (length: 1)
