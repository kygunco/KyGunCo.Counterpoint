...
namespace KyGunCo.Counterpoint.Sdk.Entities
{
    ...
    public class ImQxferTrx
    {
        ...
        /// <summary>
        /// Child ImQxferTrxCells where [IM_QXFER_TRX_CELL].([BAT_ID], [FROM_LOC_ID], [ITEM_NO], [SEQ_NO], [TO_LOC_ID], [TRX_DAT]) point to this entity (FK_IM_QXFER_TRX_CELL_IM_QXFER_TRX)
        /// </summary>
        public virtual IList<ImQxferTrxCell> ImQxferTrxCells { get; set; } = new List<ImQxferTrxCell>(); // IM_QXFER_TRX_CELL.FK_IM_QXFER_TRX_CELL_IM_QXFER_TRX

        /// <summary>
        /// Child ImQxferTrxSers where [IM_QXFER_TRX_SER].([BAT_ID], [FROM_LOC_ID], [ITEM_NO], [SEQ_NO], [TO_LOC_ID], [TRX_DAT]) point to this entity (FK_IM_QXFER_TRX_SER_IM_QXFER_TRX)
        /// </summary>
        public virtual IList<ImQxferTrxSer> ImQxferTrxSers { get; set; } = new List<ImQxferTrxSer>(); // IM_QXFER_TRX_SER.FK_IM_QXFER_TRX_SER_IM_QXFER_TRX

        // Foreign keys

        /// <summary>
        /// Parent ImLoc pointed by [IM_QXFER_TRX].([FromLocId]) (FK_IM_QXFER_TRX_IM_LOC)
        /// </summary>
        public virtual ImLoc ImLoc { get; set; } // FK_IM_QXFER_TRX_IM_LOC
    }
