...
{
    // RS_DEL_PS_DRW
    public class RsDelPsDrwConfiguration : IEntityTypeConfiguration<RsDelPsDrw>
    {
        public void Configure(EntityTypeBuilder<RsDelPsDrw> builder)
        {
            builder.ToTable("RS_DEL_PS_DRW", "dbo");
            builder.HasKey(x => x.DelId).HasName("PK_RS_DEL_PS_DRW").IsClustered();
