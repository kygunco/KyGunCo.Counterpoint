...
{
    // VI_PO_ITEM_PICKER
    public class ViPoItemPickerConfiguration : IEntityTypeConfiguration<ViPoItemPicker>
    {
        public void Configure(EntityTypeBuilder<ViPoItemPicker> builder)
        {
            builder.ToView("VI_PO_ITEM_PICKER", "dbo");
            builder.HasNoKey();
