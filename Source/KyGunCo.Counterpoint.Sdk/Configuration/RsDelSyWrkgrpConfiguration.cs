...
{
    // RS_DEL_SY_WRKGRP
    public class RsDelSyWrkgrpConfiguration : IEntityTypeConfiguration<RsDelSyWrkgrp>
    {
        public void Configure(EntityTypeBuilder<RsDelSyWrkgrp> builder)
        {
            builder.ToTable("RS_DEL_SY_WRKGRP", "dbo");
            builder.HasKey(x => x.DelId).HasName("PK_RS_DEL_SY_WRKGRP").IsClustered();
