...
{
    // VI_PS_DOC_SVC_RCPT
    public class ViPsDocSvcRcptConfiguration : IEntityTypeConfiguration<ViPsDocSvcRcpt>
    {
        public void Configure(EntityTypeBuilder<ViPsDocSvcRcpt> builder)
        {
            builder.ToView("VI_PS_DOC_SVC_RCPT", "dbo");
            builder.HasNoKey();
