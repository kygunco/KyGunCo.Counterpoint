...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class PsDocAuditLogTotConfiguration : IEntityTypeConfiguration<PsDocAuditLogTot>
    {
        public void Configure(EntityTypeBuilder<PsDocAuditLogTot> builder)
        {
            builder.ToTable("PS_DOC_AUDIT_LOG_TOT", "dbo");
            builder.HasKey(x => new { x.DocId, x.LogSeqNo, x.TotTyp }).HasName("PK_PS_DOC_AUDIT_LOG_TOT").IsClustered();
            ...
            // Foreign keys
            builder.HasOne(a => a.PsDocAuditLog).WithMany(b => b.PsDocAuditLogTots).HasForeignKey(c => new { c.DocId, c.LogSeqNo }).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_PS_DOC_AUDIT_LOG_TOT_PS_DOC_AUDIT_LOG");
        }
    }
