...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViSyStcHistWithCustConfiguration : IEntityTypeConfiguration<ViSyStcHistWithCust>
    {
        public void Configure(EntityTypeBuilder<ViSyStcHistWithCust> builder)
        {
            builder.ToView("VI_SY_STC_HIST_WITH_CUST", "dbo");
            builder.HasNoKey();

            builder.Property(x => x.EventNo).HasColumnName(@"EVENT_NO").HasColumnType("varchar(15)").IsRequired().IsUnicode(false).HasMaxLength(15);
            builder.Property(x => x.StcNo).HasColumnName(@"STC_NO").HasColumnType("varchar(30)").IsRequired().IsUnicode(false).HasMaxLength(30);
            ...
            builder.Property(x => x.CustTyp).HasColumnName(@"CUST_TYP").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            ...
            builder.Property(x => x.PromptNamAdrs).HasColumnName(@"PROMPT_NAM_ADRS").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            ...
            builder.Property(x => x.AllowArChrg).HasColumnName(@"ALLOW_AR_CHRG").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            builder.Property(x => x.AllowTkts).HasColumnName(@"ALLOW_TKTS").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            builder.Property(x => x.NoCrLim).HasColumnName(@"NO_CR_LIM").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            ...
            builder.Property(x => x.NoMaxChkAmt).HasColumnName(@"NO_MAX_CHK_AMT").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            ...
            builder.Property(x => x.BalMeth).HasColumnName(@"BAL_METH").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            ...
            builder.Property(x => x.UseOrdShipTo).HasColumnName(@"USE_ORD_SHIP_TO").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            builder.Property(x => x.AllowOrds).HasColumnName(@"ALLOW_ORDS").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            ...
            builder.Property(x => x.LstAgeFutrDocs).HasColumnName(@"LST_AGE_FUTR_DOCS").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            builder.Property(x => x.LstAgeMeth).HasColumnName(@"LST_AGE_METH").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            ...
            builder.Property(x => x.LstAgeNoCutoff).HasColumnName(@"LST_AGE_NO_CUTOFF").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            builder.Property(x => x.LstAgePastCutoff).HasColumnName(@"LST_AGE_PAST_CUTOFF").HasColumnType("decimal(15,2)").IsRequired(false);
            builder.Property(x => x.LstAgeNonStd).HasColumnName(@"LST_AGE_NON_STD").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            ...
            builder.Property(x => x.LstStmntMeth).HasColumnName(@"LST_STMNT_METH").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            ...
            builder.Property(x => x.UseLwyShipTo).HasColumnName(@"USE_LWY_SHIP_TO").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            builder.Property(x => x.AllowLwys).HasColumnName(@"ALLOW_LWYS").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            builder.Property(x => x.IsEcommCust).HasColumnName(@"IS_ECOMM_CUST").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            ...
            builder.Property(x => x.EcommNxtPubUpdt).HasColumnName(@"ECOMM_NXT_PUB_UPDT").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            builder.Property(x => x.EcommNxtPubFull).HasColumnName(@"ECOMM_NXT_PUB_FULL").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            builder.Property(x => x.EcommLstPubDt).HasColumnName(@"ECOMM_LST_PUB_DT").HasColumnType("datetime").IsRequired(false);
            builder.Property(x => x.EcommLstPubTyp).HasColumnName(@"ECOMM_LST_PUB_TYP").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            builder.Property(x => x.EcommLstImpDt).HasColumnName(@"ECOMM_LST_IMP_DT").HasColumnType("datetime").IsRequired(false);
            builder.Property(x => x.EcommCreatedCust).HasColumnName(@"ECOMM_CREATED_CUST").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            ...
            builder.Property(x => x.EcommLstImpTyp).HasColumnName(@"ECOMM_LST_IMP_TYP").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            ...
            builder.Property(x => x.PromptForCustomFlds).HasColumnName(@"PROMPT_FOR_CUSTOM_FLDS").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            ...
            builder.Property(x => x.ReqPoNo).HasColumnName(@"REQ_PO_NO").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            builder.Property(x => x.RsUtcDt).HasColumnName(@"RS_UTC_DT").HasColumnType("datetime").IsRequired(false);
            builder.Property(x => x.CustNamTyp).HasColumnName(@"CUST_NAM_TYP").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            ...
            builder.Property(x => x.EmailStatement).HasColumnName(@"EMAIL_STATEMENT").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            builder.Property(x => x.RsStat).HasColumnName(@"RS_STAT").HasColumnType("tinyint").IsRequired(false);
            builder.Property(x => x.IncludeInMarketingMailouts).HasColumnName(@"INCLUDE_IN_MARKETING_MAILOUTS").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            ...
            builder.Property(x => x.RptEmail).HasColumnName(@"RPT_EMAIL").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
