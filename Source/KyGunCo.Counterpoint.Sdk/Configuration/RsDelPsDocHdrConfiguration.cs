...
{
    // RS_DEL_PS_DOC_HDR
    public class RsDelPsDocHdrConfiguration : IEntityTypeConfiguration<RsDelPsDocHdr>
    {
        public void Configure(EntityTypeBuilder<RsDelPsDocHdr> builder)
        {
            builder.ToTable("RS_DEL_PS_DOC_HDR", "dbo");
            builder.HasKey(x => x.DelId).HasName("PK_RS_DEL_PS_DOC_HDR").IsClustered();
