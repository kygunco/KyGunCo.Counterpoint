...
{
    // VI_IM_ITEM_RCPT
    public class ViImItemRcptConfiguration : IEntityTypeConfiguration<ViImItemRcpt>
    {
        public void Configure(EntityTypeBuilder<ViImItemRcpt> builder)
        {
            builder.ToView("VI_IM_ITEM_RCPT", "dbo");
            builder.HasNoKey();
