...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class PsOrdHistLinPriceConfiguration : IEntityTypeConfiguration<PsOrdHistLinPrice>
    {
        public void Configure(EntityTypeBuilder<PsOrdHistLinPrice> builder)
        {
            builder.ToTable("PS_ORD_HIST_LIN_PRICE", "dbo");
            builder.HasKey(x => new { x.BusDat, x.DocId, x.LinSeqNo, x.PrcSeqNo }).HasName("PK_PS_ORD_HIST_LIN_PRICE").IsClustered();
            ...
            // Foreign keys
            builder.HasOne(a => a.PsOrdHistLin).WithMany(b => b.PsOrdHistLinPrices).HasForeignKey(c => new { c.BusDat, c.DocId, c.LinSeqNo }).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_PS_ORD_HIST_LIN_PRICE_PS_ORD_HIST_LIN");
        }
    }
