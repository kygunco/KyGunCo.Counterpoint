...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class PsTktHistLinSerPromptConfiguration : IEntityTypeConfiguration<PsTktHistLinSerPrompt>
    {
        public void Configure(EntityTypeBuilder<PsTktHistLinSerPrompt> builder)
        {
            builder.ToTable("PS_TKT_HIST_LIN_SER_PROMPT", "dbo");
            builder.HasKey(x => new { x.BusDat, x.DocId, x.LinSeqNo, x.SerNo, x.PromptSeqNo }).HasName("PK_PS_TKT_HIST_LIN_SER_PROMPT").IsClustered();
            ...
            // Foreign keys
            builder.HasOne(a => a.PsTktHistLinSer).WithMany(b => b.PsTktHistLinSerPrompts).HasForeignKey(c => new { c.BusDat, c.DocId, c.LinSeqNo, c.SerNo }).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_PS_TKT_HIST_LIN_SER_PROMPT_PS_TKT_HIST_LIN_SER");
        }
    }
