...
{
    // VI_TKT_HIST_CUST
    public class ViTktHistCustConfiguration : IEntityTypeConfiguration<ViTktHistCust>
    {
        public void Configure(EntityTypeBuilder<ViTktHistCust> builder)
        {
            builder.ToView("VI_TKT_HIST_CUST", "dbo");
            builder.HasNoKey();
