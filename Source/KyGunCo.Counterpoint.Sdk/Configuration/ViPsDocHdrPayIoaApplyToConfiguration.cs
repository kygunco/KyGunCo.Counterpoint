...
{
    // VI_PS_DOC_HDR_PAY_IOA_APPLY_TO
    public class ViPsDocHdrPayIoaApplyToConfiguration : IEntityTypeConfiguration<ViPsDocHdrPayIoaApplyTo>
    {
        public void Configure(EntityTypeBuilder<ViPsDocHdrPayIoaApplyTo> builder)
        {
            builder.ToView("VI_PS_DOC_HDR_PAY_IOA_APPLY_TO", "dbo");
            builder.HasNoKey();
