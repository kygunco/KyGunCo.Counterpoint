...
{
    // VI_PS_DOC_LIN_RCPT
    public class ViPsDocLinRcptConfiguration : IEntityTypeConfiguration<ViPsDocLinRcpt>
    {
        public void Configure(EntityTypeBuilder<ViPsDocLinRcpt> builder)
        {
            builder.ToView("VI_PS_DOC_LIN_RCPT", "dbo");
            builder.HasNoKey();
            ...
            builder.Property(x => x.ExtWeight).HasColumnName(@"EXT_WEIGHT").HasColumnType("numeric(35,8)").IsRequired(false);
            builder.Property(x => x.ExtCube).HasColumnName(@"EXT_CUBE").HasColumnType("numeric(35,8)").IsRequired(false);
            ...
            builder.Property(x => x.LinLvlDiscAmt).HasColumnName(@"LIN_LVL_DISC_AMT").HasColumnType("decimal(38,2)").IsRequired(false);
            builder.Property(x => x.GrossDispExtPrcIncHdrDisc).HasColumnName(@"GROSS_DISP_EXT_PRC_INC_HDR_DISC").HasColumnType("decimal(38,2)").IsRequired(false);
        }
    }
