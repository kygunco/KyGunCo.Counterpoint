...
{
    // VI_PS_ORD_HIST_DISC
    public class ViPsOrdHistDiscConfiguration : IEntityTypeConfiguration<ViPsOrdHistDisc>
    {
        public void Configure(EntityTypeBuilder<ViPsOrdHistDisc> builder)
        {
            builder.ToView("VI_PS_ORD_HIST_DISC", "dbo");
            builder.HasNoKey();
