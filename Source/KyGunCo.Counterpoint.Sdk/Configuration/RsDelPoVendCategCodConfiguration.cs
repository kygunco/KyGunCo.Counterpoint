...
{
    // RS_DEL_PO_VEND_CATEG_COD
    public class RsDelPoVendCategCodConfiguration : IEntityTypeConfiguration<RsDelPoVendCategCod>
    {
        public void Configure(EntityTypeBuilder<RsDelPoVendCategCod> builder)
        {
            builder.ToTable("RS_DEL_PO_VEND_CATEG_COD", "dbo");
            builder.HasKey(x => x.DelId).HasName("PK_RS_DEL_PO_VEND_CATEG_COD").IsClustered();
