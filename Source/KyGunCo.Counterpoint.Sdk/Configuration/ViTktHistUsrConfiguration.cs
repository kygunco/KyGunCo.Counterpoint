...
{
    // VI_TKT_HIST_USR
    public class ViTktHistUsrConfiguration : IEntityTypeConfiguration<ViTktHistUsr>
    {
        public void Configure(EntityTypeBuilder<ViTktHistUsr> builder)
        {
            builder.ToView("VI_TKT_HIST_USR", "dbo");
            builder.HasNoKey();
