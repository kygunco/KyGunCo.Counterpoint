...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViInvPrcCellExtNoPrcConfiguration : IEntityTypeConfiguration<ViInvPrcCellExtNoPrc>
    {
        public void Configure(EntityTypeBuilder<ViInvPrcCellExtNoPrc> builder)
        {
            builder.ToView("VI_INV_PRC_CELL_EXT_NO_PRCS", "dbo");
            builder.HasNoKey();
