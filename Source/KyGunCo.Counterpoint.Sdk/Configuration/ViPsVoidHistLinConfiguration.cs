...
{
    // VI_PS_VOID_HIST_LIN
    public class ViPsVoidHistLinConfiguration : IEntityTypeConfiguration<ViPsVoidHistLin>
    {
        public void Configure(EntityTypeBuilder<ViPsVoidHistLin> builder)
        {
            builder.ToView("VI_PS_VOID_HIST_LIN", "dbo");
            builder.HasNoKey();
            ...
            builder.Property(x => x.PoOrdDescr).HasColumnName(@"PO_ORD_DESCR").HasColumnType("varchar(90)").IsRequired(false).IsUnicode(false).HasMaxLength(90);
