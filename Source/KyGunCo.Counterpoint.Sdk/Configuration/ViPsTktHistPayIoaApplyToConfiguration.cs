...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViPsTktHistPayIoaApplyToConfiguration : IEntityTypeConfiguration<ViPsTktHistPayIoaApplyTo>
    {
        public void Configure(EntityTypeBuilder<ViPsTktHistPayIoaApplyTo> builder)
        {
            builder.ToView("VI_PS_TKT_HIST_PAY_IOA_APPLY_TO", "dbo");
            builder.HasNoKey();
