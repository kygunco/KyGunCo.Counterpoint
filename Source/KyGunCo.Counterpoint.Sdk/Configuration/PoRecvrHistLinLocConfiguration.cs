...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class PoRecvrHistLinLocConfiguration : IEntityTypeConfiguration<PoRecvrHistLinLoc>
    {
        public void Configure(EntityTypeBuilder<PoRecvrHistLinLoc> builder)
        {
            builder.ToTable("PO_RECVR_HIST_LIN_LOC", "dbo");
            builder.HasKey(x => new { x.RecvrNo, x.SeqNo, x.LocId }).HasName("PK_PO_RECVR_HIST_LIN_LOC").IsClustered();
            ...
            // Foreign keys
            builder.HasOne(a => a.PoRecvrHistLin).WithMany(b => b.PoRecvrHistLinLocs).HasForeignKey(c => new { c.RecvrNo, c.SeqNo }).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_PO_RECVR_HIST_LIN_LOC_PO_RECVR_HIST_LIN");
        }
    }
