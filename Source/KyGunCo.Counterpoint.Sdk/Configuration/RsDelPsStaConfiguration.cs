...
{
    // RS_DEL_PS_STA
    public class RsDelPsStaConfiguration : IEntityTypeConfiguration<RsDelPsSta>
    {
        public void Configure(EntityTypeBuilder<RsDelPsSta> builder)
        {
            builder.ToTable("RS_DEL_PS_STA", "dbo");
            builder.HasKey(x => x.DelId).HasName("PK_RS_DEL_PS_STA").IsClustered();
