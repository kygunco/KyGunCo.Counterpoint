...
{
    // RS_DEL_AR_STMNT_COD
    public class RsDelArStmntCodConfiguration : IEntityTypeConfiguration<RsDelArStmntCod>
    {
        public void Configure(EntityTypeBuilder<RsDelArStmntCod> builder)
        {
            builder.ToTable("RS_DEL_AR_STMNT_COD", "dbo");
            builder.HasKey(x => x.DelId).HasName("PK_RS_DEL_AR_STMNT_COD").IsClustered();
