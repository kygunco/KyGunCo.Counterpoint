...
{
    // VI_PS_ORD_HIST_PMT
    public class ViPsOrdHistPmtConfiguration : IEntityTypeConfiguration<ViPsOrdHistPmt>
    {
        public void Configure(EntityTypeBuilder<ViPsOrdHistPmt> builder)
        {
            builder.ToView("VI_PS_ORD_HIST_PMT", "dbo");
            builder.HasNoKey();
            ...
            builder.Property(x => x.OrdAmt).HasColumnName(@"ORD_AMT").HasColumnType("decimal(15,2)").IsRequired();
