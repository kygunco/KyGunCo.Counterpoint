...
{
    // RS_DEL_AR_CUST
    public class RsDelArCustConfiguration : IEntityTypeConfiguration<RsDelArCust>
    {
        public void Configure(EntityTypeBuilder<RsDelArCust> builder)
        {
            builder.ToTable("RS_DEL_AR_CUST", "dbo");
            builder.HasKey(x => x.DelId).HasName("PK_RS_DEL_AR_CUST").IsClustered();
