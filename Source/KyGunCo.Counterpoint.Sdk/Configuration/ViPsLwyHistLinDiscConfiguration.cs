...
{
    // VI_PS_LWY_HIST_LIN_DISC
    public class ViPsLwyHistLinDiscConfiguration : IEntityTypeConfiguration<ViPsLwyHistLinDisc>
    {
        public void Configure(EntityTypeBuilder<ViPsLwyHistLinDisc> builder)
        {
            builder.ToView("VI_PS_LWY_HIST_LIN_DISC", "dbo");
            builder.HasNoKey();
