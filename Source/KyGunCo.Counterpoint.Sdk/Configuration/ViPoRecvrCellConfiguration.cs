...
{
    // VI_PO_RECVR_CELL
    public class ViPoRecvrCellConfiguration : IEntityTypeConfiguration<ViPoRecvrCell>
    {
        public void Configure(EntityTypeBuilder<ViPoRecvrCell> builder)
        {
            builder.ToView("VI_PO_RECVR_CELL", "dbo");
            builder.HasNoKey();
