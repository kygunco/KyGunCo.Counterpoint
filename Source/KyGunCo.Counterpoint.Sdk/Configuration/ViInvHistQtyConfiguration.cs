...
{
    // VI_INV_HIST_QTY
    public class ViInvHistQtyConfiguration : IEntityTypeConfiguration<ViInvHistQty>
    {
        public void Configure(EntityTypeBuilder<ViInvHistQty> builder)
        {
            builder.ToView("VI_INV_HIST_QTY", "dbo");
            builder.HasNoKey();
