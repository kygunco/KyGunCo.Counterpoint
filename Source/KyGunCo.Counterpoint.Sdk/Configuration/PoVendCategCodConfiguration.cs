...
{
    // PO_VEND_CATEG_COD
    public class PoVendCategCodConfiguration : IEntityTypeConfiguration<PoVendCategCod>
    {
        public void Configure(EntityTypeBuilder<PoVendCategCod> builder)
        {
            builder.ToTable("PO_VEND_CATEG_COD", "dbo");
            builder.HasKey(x => x.CategCod).HasName("PK_PO_VEND_CATEG_COD").IsClustered();
            ...
            builder.HasIndex(x => x.RsStat).HasDatabaseName("PO_VEND_CATEG_COD_X_RS_STAT");
            builder.HasIndex(x => x.RsUtcDt).HasDatabaseName("PO_VEND_CATEG_COD_X_RS_UTC_DT");
            builder.HasIndex(x => new { x.DescrUpr, x.CategCod }).HasDatabaseName("PO_VEND_CATEG_COD_X1");
        }
    }
