...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class PsLwyHistLinPriceConfiguration : IEntityTypeConfiguration<PsLwyHistLinPrice>
    {
        public void Configure(EntityTypeBuilder<PsLwyHistLinPrice> builder)
        {
            builder.ToTable("PS_LWY_HIST_LIN_PRICE", "dbo");
            builder.HasKey(x => new { x.BusDat, x.DocId, x.LinSeqNo, x.PrcSeqNo }).HasName("PK_PS_LWY_HIST_LIN_PRICE").IsClustered();
            ...
            // Foreign keys
            builder.HasOne(a => a.PsLwyHistLin).WithMany(b => b.PsLwyHistLinPrices).HasForeignKey(c => new { c.BusDat, c.DocId, c.LinSeqNo }).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_PS_LWY_HIST_LIN_PRICE_PS_LWY_HIST_LIN");
        }
    }
