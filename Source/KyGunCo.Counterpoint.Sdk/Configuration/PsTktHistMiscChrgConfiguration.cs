...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class PsTktHistMiscChrgConfiguration : IEntityTypeConfiguration<PsTktHistMiscChrg>
    {
        public void Configure(EntityTypeBuilder<PsTktHistMiscChrg> builder)
        {
            builder.ToTable("PS_TKT_HIST_MISC_CHRG", "dbo");
            builder.HasKey(x => new { x.BusDat, x.DocId, x.MiscChrgNo }).HasName("PK_PS_TKT_HIST_MISC_CHRG").IsClustered();
            ...
            // Foreign keys
            builder.HasOne(a => a.PsTktHist).WithMany(b => b.PsTktHistMiscChrgs).HasForeignKey(c => new { c.BusDat, c.DocId }).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_PS_TKT_HIST_MISC_CHRG_PS_TKT_HIST");
        }
    }
