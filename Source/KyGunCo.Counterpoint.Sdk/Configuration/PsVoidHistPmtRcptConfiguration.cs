...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class PsVoidHistPmtRcptConfiguration : IEntityTypeConfiguration<PsVoidHistPmtRcpt>
    {
        public void Configure(EntityTypeBuilder<PsVoidHistPmtRcpt> builder)
        {
            builder.ToTable("PS_VOID_HIST_PMT_RCPT", "dbo");
            builder.HasKey(x => new { x.BusDat, x.DocId, x.PmtSeqNo }).HasName("PK_PS_VOID_HIST_PMT_RCPT").IsClustered();
            ...
            // Foreign keys
            builder.HasOne(a => a.PsVoidHistPmt).WithOne(b => b.PsVoidHistPmtRcpt).HasForeignKey<PsVoidHistPmtRcpt>(c => new { c.BusDat, c.DocId, c.PmtSeqNo }).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_PS_VOID_HIST_PMT_RCPT_PS_VOID_HIST_PMT");
        }
    }
