...
{
    // RS_DEL_AR_FCH_COD
    public class RsDelArFchCodConfiguration : IEntityTypeConfiguration<RsDelArFchCod>
    {
        public void Configure(EntityTypeBuilder<RsDelArFchCod> builder)
        {
            builder.ToTable("RS_DEL_AR_FCH_COD", "dbo");
            builder.HasKey(x => x.DelId).HasName("PK_RS_DEL_AR_FCH_COD").IsClustered();
