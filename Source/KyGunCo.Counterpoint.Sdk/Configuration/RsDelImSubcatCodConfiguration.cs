...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class RsDelImSubcatCodConfiguration : IEntityTypeConfiguration<RsDelImSubcatCod>
    {
        public void Configure(EntityTypeBuilder<RsDelImSubcatCod> builder)
        {
            builder.ToTable("RS_DEL_IM_SUBCAT_COD", "dbo");
            builder.HasKey(x => x.DelId).HasName("PK_RS_DEL_IM_SUBCAT_COD").IsClustered();
