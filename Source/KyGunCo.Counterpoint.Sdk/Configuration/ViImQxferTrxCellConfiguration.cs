...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViImQxferTrxCellConfiguration : IEntityTypeConfiguration<ViImQxferTrxCell>
    {
        public void Configure(EntityTypeBuilder<ViImQxferTrxCell> builder)
        {
            builder.ToView("VI_IM_QXFER_TRX_CELL", "dbo");
            builder.HasNoKey();
