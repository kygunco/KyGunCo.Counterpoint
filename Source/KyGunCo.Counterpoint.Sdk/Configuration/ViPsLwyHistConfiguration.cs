...
{
    // VI_PS_LWY_HIST
    public class ViPsLwyHistConfiguration : IEntityTypeConfiguration<ViPsLwyHist>
    {
        public void Configure(EntityTypeBuilder<ViPsLwyHist> builder)
        {
            builder.ToView("VI_PS_LWY_HIST", "dbo");
            builder.HasNoKey();
            ...
            builder.Property(x => x.LwyHasTaxOvrd).HasColumnName(@"LWY_HAS_TAX_OVRD").HasColumnType("varchar(1)").IsRequired().IsUnicode(false).HasMaxLength(1);
            builder.Property(x => x.LwyTaxOvrdLins).HasColumnName(@"LWY_TAX_OVRD_LINS").HasColumnType("int").IsRequired();
            builder.Property(x => x.LwyGrossSubTot).HasColumnName(@"LWY_GROSS_SUB_TOT").HasColumnType("decimal(16,2)").IsRequired(false);
            builder.Property(x => x.LwySubTot).HasColumnName(@"LWY_SUB_TOT").HasColumnType("decimal(15,2)").IsRequired();
            builder.Property(x => x.LwyTotHdrDisc).HasColumnName(@"LWY_TOT_HDR_DISC").HasColumnType("decimal(15,2)").IsRequired();
            builder.Property(x => x.LwyTotLinDisc).HasColumnName(@"LWY_TOT_LIN_DISC").HasColumnType("decimal(15,2)").IsRequired();
            builder.Property(x => x.LwyTotDisc).HasColumnName(@"LWY_TOT_DISC").HasColumnType("decimal(16,2)").IsRequired(false);
            builder.Property(x => x.LwyTotEstCost).HasColumnName(@"LWY_TOT_EST_COST").HasColumnType("decimal(15,2)").IsRequired(false);
            builder.Property(x => x.LwyTotWeight).HasColumnName(@"LWY_TOT_WEIGHT").HasColumnType("numeric(19,4)").IsRequired();
            builder.Property(x => x.LwyTotCube).HasColumnName(@"LWY_TOT_CUBE").HasColumnType("numeric(19,4)").IsRequired();
            builder.Property(x => x.LwyTotMisc).HasColumnName(@"LWY_TOT_MISC").HasColumnType("decimal(15,2)").IsRequired();
            builder.Property(x => x.LwyNormTaxAmt).HasColumnName(@"LWY_NORM_TAX_AMT").HasColumnType("decimal(15,2)").IsRequired();
            builder.Property(x => x.LwyTaxAmt).HasColumnName(@"LWY_TAX_AMT").HasColumnType("decimal(15,2)").IsRequired();
            builder.Property(x => x.LwyTaxAmtShipped).HasColumnName(@"LWY_TAX_AMT_SHIPPED").HasColumnType("decimal(15,2)").IsRequired();
            builder.Property(x => x.LwyTot).HasColumnName(@"LWY_TOT").HasColumnType("decimal(15,2)").IsRequired();
            builder.Property(x => x.LwyInitialMinDue).HasColumnName(@"LWY_INITIAL_MIN_DUE").HasColumnType("decimal(15,2)").IsRequired();
            builder.Property(x => x.LwyTotTnd).HasColumnName(@"LWY_TOT_TND").HasColumnType("decimal(15,2)").IsRequired();
            builder.Property(x => x.LwyTotChng).HasColumnName(@"LWY_TOT_CHNG").HasColumnType("decimal(15,2)").IsRequired();
            builder.Property(x => x.LwyNetTnd).HasColumnName(@"LWY_NET_TND").HasColumnType("decimal(16,2)").IsRequired(false);
            builder.Property(x => x.LwyAmtDue).HasColumnName(@"LWY_AMT_DUE").HasColumnType("decimal(15,2)").IsRequired();
