...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class UserViRentalFirearmConfiguration : IEntityTypeConfiguration<UserViRentalFirearm>
    {
        public void Configure(EntityTypeBuilder<UserViRentalFirearm> builder)
        {
            builder.ToView("USER_VI_RENTAL_FIREARM", "dbo");
            builder.HasNoKey();
