...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViPsVoidHistAuditLogConfiguration : IEntityTypeConfiguration<ViPsVoidHistAuditLog>
    {
        public void Configure(EntityTypeBuilder<ViPsVoidHistAuditLog> builder)
        {
            builder.ToView("VI_PS_VOID_HIST_AUDIT_LOG", "dbo");
            builder.HasNoKey();
