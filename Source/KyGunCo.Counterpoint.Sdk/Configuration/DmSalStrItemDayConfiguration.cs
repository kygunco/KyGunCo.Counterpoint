...
{
    // DM_SAL_STR_ITEM_DAY
    public class DmSalStrItemDayConfiguration : IEntityTypeConfiguration<DmSalStrItemDay>
    {
        public void Configure(EntityTypeBuilder<DmSalStrItemDay> builder)
        {
            builder.ToTable("DM_SAL_STR_ITEM_DAY", "dbo");
            builder.HasKey(x => new { x.PostDat, x.StrId, x.LocId, x.ItemNo, x.Dim1Upr, x.Dim2Upr, x.Dim3Upr, x.VendNo, x.CategCod, x.SubcatCod }).HasName("PK_DM_SAL_STR_ITEM_DAY").IsClustered();
            ...
            builder.HasIndex(x => new { x.StrId, x.PostDat, x.LocId, x.ItemNo, x.Dim1Upr, x.Dim2Upr, x.Dim3Upr, x.VendNo, x.CategCod, x.SubcatCod }).HasDatabaseName("DM_SAL_STR_ITEM_DAY_X1");
        }
    }
