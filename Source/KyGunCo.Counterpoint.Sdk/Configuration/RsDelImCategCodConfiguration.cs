...
{
    // RS_DEL_IM_CATEG_COD
    public class RsDelImCategCodConfiguration : IEntityTypeConfiguration<RsDelImCategCod>
    {
        public void Configure(EntityTypeBuilder<RsDelImCategCod> builder)
        {
            builder.ToTable("RS_DEL_IM_CATEG_COD", "dbo");
            builder.HasKey(x => x.DelId).HasName("PK_RS_DEL_IM_CATEG_COD").IsClustered();
