...
{
    // VI_PS_VOID_HIST_DISC
    public class ViPsVoidHistDiscConfiguration : IEntityTypeConfiguration<ViPsVoidHistDisc>
    {
        public void Configure(EntityTypeBuilder<ViPsVoidHistDisc> builder)
        {
            builder.ToView("VI_PS_VOID_HIST_DISC", "dbo");
            builder.HasNoKey();
