...
{
    // RS_DEL_IM_TARE_COD
    public class RsDelImTareCodConfiguration : IEntityTypeConfiguration<RsDelImTareCod>
    {
        public void Configure(EntityTypeBuilder<RsDelImTareCod> builder)
        {
            builder.ToTable("RS_DEL_IM_TARE_COD", "dbo");
            builder.HasKey(x => x.DelId).HasName("PK_RS_DEL_IM_TARE_COD").IsClustered();
