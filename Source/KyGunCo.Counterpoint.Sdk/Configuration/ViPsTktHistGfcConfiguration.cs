...
{
    // VI_PS_TKT_HIST_GFC
    public class ViPsTktHistGfcConfiguration : IEntityTypeConfiguration<ViPsTktHistGfc>
    {
        public void Configure(EntityTypeBuilder<ViPsTktHistGfc> builder)
        {
            builder.ToView("VI_PS_TKT_HIST_GFC", "dbo");
            builder.HasNoKey();
