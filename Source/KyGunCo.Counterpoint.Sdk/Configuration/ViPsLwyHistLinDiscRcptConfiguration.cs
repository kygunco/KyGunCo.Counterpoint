...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViPsLwyHistLinDiscRcptConfiguration : IEntityTypeConfiguration<ViPsLwyHistLinDiscRcpt>
    {
        public void Configure(EntityTypeBuilder<ViPsLwyHistLinDiscRcpt> builder)
        {
            builder.ToView("VI_PS_LWY_HIST_LIN_DISC_RCPT", "dbo");
            builder.HasNoKey();
