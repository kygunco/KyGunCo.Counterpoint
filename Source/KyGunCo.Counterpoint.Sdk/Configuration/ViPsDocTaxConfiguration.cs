...
{
    // VI_PS_DOC_TAX
    public class ViPsDocTaxConfiguration : IEntityTypeConfiguration<ViPsDocTax>
    {
        public void Configure(EntityTypeBuilder<ViPsDocTax> builder)
        {
            builder.ToView("VI_PS_DOC_TAX", "dbo");
            builder.HasNoKey();
