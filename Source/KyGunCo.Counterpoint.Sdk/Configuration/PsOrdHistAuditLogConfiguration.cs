...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class PsOrdHistAuditLogConfiguration : IEntityTypeConfiguration<PsOrdHistAuditLog>
    {
        public void Configure(EntityTypeBuilder<PsOrdHistAuditLog> builder)
        {
            builder.ToTable("PS_ORD_HIST_AUDIT_LOG", "dbo");
            builder.HasKey(x => new { x.BusDat, x.DocId, x.LogSeqNo }).HasName("PK_PS_ORD_HIST_AUDIT_LOG").IsClustered();
            ...
            // Foreign keys
            builder.HasOne(a => a.PsOrdHist).WithMany(b => b.PsOrdHistAuditLogs).HasForeignKey(c => new { c.BusDat, c.DocId }).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_PS_ORD_HIST_AUDIT_LOG_PS_ORD_HIST");
        }
    }
