...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViPsTktHistLinSerConfiguration : IEntityTypeConfiguration<ViPsTktHistLinSer>
    {
        public void Configure(EntityTypeBuilder<ViPsTktHistLinSer> builder)
        {
            builder.ToView("VI_PS_TKT_HIST_LIN_SER", "dbo");
            builder.HasNoKey();
