...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class UserOrderTaxDetailConfiguration : IEntityTypeConfiguration<UserOrderTaxDetail>
    {
        public void Configure(EntityTypeBuilder<UserOrderTaxDetail> builder)
        {
            builder.ToView("USER_ORDER_TAX_DETAILS", "dbo");
            builder.HasNoKey();
            ...
            builder.Property(x => x.TaxDocPart).HasColumnName(@"TAX_DOC_PART").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
