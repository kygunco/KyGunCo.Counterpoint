...
{
    // VI_PS_TKT_HIST_DISC_RCPT
    public class ViPsTktHistDiscRcptConfiguration : IEntityTypeConfiguration<ViPsTktHistDiscRcpt>
    {
        public void Configure(EntityTypeBuilder<ViPsTktHistDiscRcpt> builder)
        {
            builder.ToView("VI_PS_TKT_HIST_DISC_RCPT", "dbo");
            builder.HasNoKey();
