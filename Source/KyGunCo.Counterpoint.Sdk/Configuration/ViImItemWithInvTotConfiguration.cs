...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViImItemWithInvTotConfiguration : IEntityTypeConfiguration<ViImItemWithInvTot>
    {
        public void Configure(EntityTypeBuilder<ViImItemWithInvTot> builder)
        {
            builder.ToView("VI_IM_ITEM_WITH_INV_TOTS", "dbo");
            builder.HasNoKey();
