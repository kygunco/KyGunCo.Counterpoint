...
{
    // VI_PS_LWY_HIST_LIN_SER
    public class ViPsLwyHistLinSerConfiguration : IEntityTypeConfiguration<ViPsLwyHistLinSer>
    {
        public void Configure(EntityTypeBuilder<ViPsLwyHistLinSer> builder)
        {
            builder.ToView("VI_PS_LWY_HIST_LIN_SER", "dbo");
            builder.HasNoKey();
