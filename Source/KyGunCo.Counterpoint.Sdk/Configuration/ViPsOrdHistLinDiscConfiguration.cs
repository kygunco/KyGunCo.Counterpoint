...
{
    // VI_PS_ORD_HIST_LIN_DISC
    public class ViPsOrdHistLinDiscConfiguration : IEntityTypeConfiguration<ViPsOrdHistLinDisc>
    {
        public void Configure(EntityTypeBuilder<ViPsOrdHistLinDisc> builder)
        {
            builder.ToView("VI_PS_ORD_HIST_LIN_DISC", "dbo");
            builder.HasNoKey();
