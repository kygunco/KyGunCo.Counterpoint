...
{
    // VI_PS_TKT_HIST_NOTE
    public class ViPsTktHistNoteConfiguration : IEntityTypeConfiguration<ViPsTktHistNote>
    {
        public void Configure(EntityTypeBuilder<ViPsTktHistNote> builder)
        {
            builder.ToView("VI_PS_TKT_HIST_NOTE", "dbo");
            builder.HasNoKey();
