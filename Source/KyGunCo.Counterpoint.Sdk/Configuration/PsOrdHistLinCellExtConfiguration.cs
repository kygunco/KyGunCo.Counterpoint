...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class PsOrdHistLinCellExtConfiguration : IEntityTypeConfiguration<PsOrdHistLinCellExt>
    {
        public void Configure(EntityTypeBuilder<PsOrdHistLinCellExt> builder)
        {
            builder.ToTable("PS_ORD_HIST_LIN_CELL_EXT", "dbo");
            builder.HasKey(x => new { x.BusDatExt, x.DocIdExt, x.LinSeqNoExt, x.Dim1UprExt, x.Dim2UprExt, x.Dim3UprExt }).HasName("PK_PS_ORD_HIST_LIN_CELL_EXT").IsClustered();
            ...
            // Foreign keys
            builder.HasOne(a => a.PsOrdHistLinCell).WithOne(b => b.PsOrdHistLinCellExt).HasForeignKey<PsOrdHistLinCellExt>(c => new { c.BusDatExt, c.DocIdExt, c.LinSeqNoExt, c.Dim1UprExt, c.Dim2UprExt, c.Dim3UprExt }).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_PS_ORD_HIST_LIN_CELL_EXT_PS_ORD_HIST_LIN_CELL");
        }
    }
