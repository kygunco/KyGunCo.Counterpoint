...
{
    // VI_PS_DOC_NOTE
    public class ViPsDocNoteConfiguration : IEntityTypeConfiguration<ViPsDocNote>
    {
        public void Configure(EntityTypeBuilder<ViPsDocNote> builder)
        {
            builder.ToView("VI_PS_DOC_NOTE", "dbo");
            builder.HasNoKey();
