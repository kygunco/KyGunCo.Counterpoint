...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class RsDelPoVendTermsCodConfiguration : IEntityTypeConfiguration<RsDelPoVendTermsCod>
    {
        public void Configure(EntityTypeBuilder<RsDelPoVendTermsCod> builder)
        {
            builder.ToTable("RS_DEL_PO_VEND_TERMS_COD", "dbo");
            builder.HasKey(x => x.DelId).HasName("PK_RS_DEL_PO_VEND_TERMS_COD").IsClustered();
