...
{
    // RS_DEL_IM_MIX_MATCH_COD
    public class RsDelImMixMatchCodConfiguration : IEntityTypeConfiguration<RsDelImMixMatchCod>
    {
        public void Configure(EntityTypeBuilder<RsDelImMixMatchCod> builder)
        {
            builder.ToTable("RS_DEL_IM_MIX_MATCH_COD", "dbo");
            builder.HasKey(x => x.DelId).HasName("PK_RS_DEL_IM_MIX_MATCH_COD").IsClustered();
