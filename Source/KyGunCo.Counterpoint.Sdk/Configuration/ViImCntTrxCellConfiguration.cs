...
{
    // VI_IM_CNT_TRX_CELL
    public class ViImCntTrxCellConfiguration : IEntityTypeConfiguration<ViImCntTrxCell>
    {
        public void Configure(EntityTypeBuilder<ViImCntTrxCell> builder)
        {
            builder.ToView("VI_IM_CNT_TRX_CELL", "dbo");
            builder.HasNoKey();
            ...
            builder.Property(x => x.NoCntCellVar).HasColumnName(@"NO_CNT_CELL_VAR").HasColumnType("decimal(15,4)").IsRequired(false);
            builder.Property(x => x.CntOnlyCellVar).HasColumnName(@"CNT_ONLY_CELL_VAR").HasColumnType("decimal(38,15)").IsRequired(false);
        }
    }
