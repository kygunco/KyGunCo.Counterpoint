...
{
    // VI_IM_XFER_CELL
    public class ViImXferCellConfiguration : IEntityTypeConfiguration<ViImXferCell>
    {
        public void Configure(EntityTypeBuilder<ViImXferCell> builder)
        {
            builder.ToView("VI_IM_XFER_CELL", "dbo");
            builder.HasNoKey();
