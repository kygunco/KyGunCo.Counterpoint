...
{
    // VI_PS_ORD_HIST_AUDIT_LOG
    public class ViPsOrdHistAuditLogConfiguration : IEntityTypeConfiguration<ViPsOrdHistAuditLog>
    {
        public void Configure(EntityTypeBuilder<ViPsOrdHistAuditLog> builder)
        {
            builder.ToView("VI_PS_ORD_HIST_AUDIT_LOG", "dbo");
            builder.HasNoKey();
