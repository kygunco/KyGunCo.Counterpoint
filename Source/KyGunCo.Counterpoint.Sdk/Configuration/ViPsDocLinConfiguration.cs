...
{
    // VI_PS_DOC_LIN
    public class ViPsDocLinConfiguration : IEntityTypeConfiguration<ViPsDocLin>
    {
        public void Configure(EntityTypeBuilder<ViPsDocLin> builder)
        {
            builder.ToView("VI_PS_DOC_LIN", "dbo");
            builder.HasNoKey();
