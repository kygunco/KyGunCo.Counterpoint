...
{
    // RS_DEL_AR_CATEG_COD
    public class RsDelArCategCodConfiguration : IEntityTypeConfiguration<RsDelArCategCod>
    {
        public void Configure(EntityTypeBuilder<RsDelArCategCod> builder)
        {
            builder.ToTable("RS_DEL_AR_CATEG_COD", "dbo");
            builder.HasKey(x => x.DelId).HasName("PK_RS_DEL_AR_CATEG_COD").IsClustered();
