...
{
    // VI_SY_STC_WITH_CUST
    public class ViSyStcWithCustConfiguration : IEntityTypeConfiguration<ViSyStcWithCust>
    {
        public void Configure(EntityTypeBuilder<ViSyStcWithCust> builder)
        {
            builder.ToView("VI_SY_STC_WITH_CUST", "dbo");
            builder.HasNoKey();
