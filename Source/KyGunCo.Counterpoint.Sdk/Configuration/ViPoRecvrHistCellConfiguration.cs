...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViPoRecvrHistCellConfiguration : IEntityTypeConfiguration<ViPoRecvrHistCell>
    {
        public void Configure(EntityTypeBuilder<ViPoRecvrHistCell> builder)
        {
            builder.ToView("VI_PO_RECVR_HIST_CELL", "dbo");
            builder.HasNoKey();
