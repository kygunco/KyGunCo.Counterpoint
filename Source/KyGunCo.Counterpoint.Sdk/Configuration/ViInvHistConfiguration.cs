...
{
    // VI_INV_HIST
    public class ViInvHistConfiguration : IEntityTypeConfiguration<ViInvHist>
    {
        public void Configure(EntityTypeBuilder<ViInvHist> builder)
        {
            builder.ToView("VI_INV_HIST", "dbo");
            builder.HasNoKey();
