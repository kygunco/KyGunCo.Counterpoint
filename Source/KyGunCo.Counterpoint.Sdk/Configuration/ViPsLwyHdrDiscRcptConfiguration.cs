...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViPsLwyHdrDiscRcptConfiguration : IEntityTypeConfiguration<ViPsLwyHdrDiscRcpt>
    {
        public void Configure(EntityTypeBuilder<ViPsLwyHdrDiscRcpt> builder)
        {
            builder.ToView("VI_PS_LWY_HDR_DISC_RCPT", "dbo");
            builder.HasNoKey();
