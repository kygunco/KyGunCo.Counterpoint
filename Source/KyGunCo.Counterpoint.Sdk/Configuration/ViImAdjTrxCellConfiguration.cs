...
{
    // VI_IM_ADJ_TRX_CELL
    public class ViImAdjTrxCellConfiguration : IEntityTypeConfiguration<ViImAdjTrxCell>
    {
        public void Configure(EntityTypeBuilder<ViImAdjTrxCell> builder)
        {
            builder.ToView("VI_IM_ADJ_TRX_CELL", "dbo");
            builder.HasNoKey();
