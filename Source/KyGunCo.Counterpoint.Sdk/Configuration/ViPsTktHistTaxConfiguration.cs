...
{
    // VI_PS_TKT_HIST_TAX
    public class ViPsTktHistTaxConfiguration : IEntityTypeConfiguration<ViPsTktHistTax>
    {
        public void Configure(EntityTypeBuilder<ViPsTktHistTax> builder)
        {
            builder.ToView("VI_PS_TKT_HIST_TAX", "dbo");
            builder.HasNoKey();
