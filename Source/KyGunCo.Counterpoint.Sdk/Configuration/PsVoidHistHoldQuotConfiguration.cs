...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class PsVoidHistHoldQuotConfiguration : IEntityTypeConfiguration<PsVoidHistHoldQuot>
    {
        public void Configure(EntityTypeBuilder<PsVoidHistHoldQuot> builder)
        {
            builder.ToTable("PS_VOID_HIST_HOLD_QUOT", "dbo");
            builder.HasKey(x => new { x.BusDat, x.DocId }).HasName("PK_PS_VOID_HIST_HOLD_QUOT").IsClustered();
            ...
            // Foreign keys
            builder.HasOne(a => a.PsVoidHist).WithOne(b => b.PsVoidHistHoldQuot).HasForeignKey<PsVoidHistHoldQuot>(c => new { c.BusDat, c.DocId }).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_PS_VOID_HIST_HOLD_QUOT_PS_VOID_HIST");
        }
    }
