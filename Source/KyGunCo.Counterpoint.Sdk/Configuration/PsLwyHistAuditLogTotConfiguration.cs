...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class PsLwyHistAuditLogTotConfiguration : IEntityTypeConfiguration<PsLwyHistAuditLogTot>
    {
        public void Configure(EntityTypeBuilder<PsLwyHistAuditLogTot> builder)
        {
            builder.ToTable("PS_LWY_HIST_AUDIT_LOG_TOT", "dbo");
            builder.HasKey(x => new { x.BusDat, x.DocId, x.LogSeqNo, x.TotTyp }).HasName("PK_PS_LWY_HIST_AUDIT_LOG_TOT").IsClustered();
            ...
            // Foreign keys
            builder.HasOne(a => a.PsLwyHistAuditLog).WithMany(b => b.PsLwyHistAuditLogTots).HasForeignKey(c => new { c.BusDat, c.DocId, c.LogSeqNo }).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_PS_LWY_HIST_AUDIT_LOG_TOT_PS_LWY_HIST_AUDIT_LOG");
        }
    }
