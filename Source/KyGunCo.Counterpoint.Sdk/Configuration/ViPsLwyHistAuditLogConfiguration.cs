...
{
    // VI_PS_LWY_HIST_AUDIT_LOG
    public class ViPsLwyHistAuditLogConfiguration : IEntityTypeConfiguration<ViPsLwyHistAuditLog>
    {
        public void Configure(EntityTypeBuilder<ViPsLwyHistAuditLog> builder)
        {
            builder.ToView("VI_PS_LWY_HIST_AUDIT_LOG", "dbo");
            builder.HasNoKey();
