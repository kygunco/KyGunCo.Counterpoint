...
{
    // VI_IM_ADJ_HIST_CELL
    public class ViImAdjHistCellConfiguration : IEntityTypeConfiguration<ViImAdjHistCell>
    {
        public void Configure(EntityTypeBuilder<ViImAdjHistCell> builder)
        {
            builder.ToView("VI_IM_ADJ_HIST_CELL", "dbo");
            builder.HasNoKey();
