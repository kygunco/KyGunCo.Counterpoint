...
{
    // VI_PS_TKT_HIST_LIN_DISC
    public class ViPsTktHistLinDiscConfiguration : IEntityTypeConfiguration<ViPsTktHistLinDisc>
    {
        public void Configure(EntityTypeBuilder<ViPsTktHistLinDisc> builder)
        {
            builder.ToView("VI_PS_TKT_HIST_LIN_DISC", "dbo");
            builder.HasNoKey();
