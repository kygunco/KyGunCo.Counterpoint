...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViPsLwyHistLinCellConfiguration : IEntityTypeConfiguration<ViPsLwyHistLinCell>
    {
        public void Configure(EntityTypeBuilder<ViPsLwyHistLinCell> builder)
        {
            builder.ToView("VI_PS_LWY_HIST_LIN_CELL", "dbo");
            builder.HasNoKey();
