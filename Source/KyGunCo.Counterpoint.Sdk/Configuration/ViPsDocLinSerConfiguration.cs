...
{
    // VI_PS_DOC_LIN_SER
    public class ViPsDocLinSerConfiguration : IEntityTypeConfiguration<ViPsDocLinSer>
    {
        public void Configure(EntityTypeBuilder<ViPsDocLinSer> builder)
        {
            builder.ToView("VI_PS_DOC_LIN_SER", "dbo");
            builder.HasNoKey();
