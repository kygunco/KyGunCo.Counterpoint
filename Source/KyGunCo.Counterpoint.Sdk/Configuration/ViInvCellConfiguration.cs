...
{
    // VI_INV_CELL
    public class ViInvCellConfiguration : IEntityTypeConfiguration<ViInvCell>
    {
        public void Configure(EntityTypeBuilder<ViInvCell> builder)
        {
            builder.ToView("VI_INV_CELL", "dbo");
            builder.HasNoKey();
            ...
            builder.Property(x => x.IsStocked).HasColumnName(@"IS_STOCKED").HasColumnType("varchar(1)").IsRequired().IsUnicode(false).HasMaxLength(1);
        }
    }
