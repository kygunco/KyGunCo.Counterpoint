...
{
    // VI_PS_LWY_HIST_PKG_TRK_NO
    public class ViPsLwyHistPkgTrkNoConfiguration : IEntityTypeConfiguration<ViPsLwyHistPkgTrkNo>
    {
        public void Configure(EntityTypeBuilder<ViPsLwyHistPkgTrkNo> builder)
        {
            builder.ToView("VI_PS_LWY_HIST_PKG_TRK_NO", "dbo");
            builder.HasNoKey();
