...
{
    // VI_PS_TKT_HIST_GRID
    public class ViPsTktHistGridConfiguration : IEntityTypeConfiguration<ViPsTktHistGrid>
    {
        public void Configure(EntityTypeBuilder<ViPsTktHistGrid> builder)
        {
            builder.ToView("VI_PS_TKT_HIST_GRID", "dbo");
            builder.HasNoKey();
            ...
            builder.Property(x => x.ExtCost).HasColumnName(@"EXT_COST").HasColumnType("decimal(35,8)").IsRequired(false);
            builder.Property(x => x.ExtPrc).HasColumnName(@"EXT_PRC").HasColumnType("decimal(35,8)").IsRequired(false);
            ...
            builder.Property(x => x.GrossProfit).HasColumnName(@"GROSS_PROFIT").HasColumnType("decimal(37,8)").IsRequired(false);
            builder.Property(x => x.CellQtySold).HasColumnName(@"CELL_QTY_SOLD").HasColumnType("decimal(15,4)").IsRequired();
