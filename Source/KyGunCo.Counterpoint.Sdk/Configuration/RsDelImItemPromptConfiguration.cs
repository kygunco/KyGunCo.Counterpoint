...
{
    // RS_DEL_IM_ITEM_PROMPT
    public class RsDelImItemPromptConfiguration : IEntityTypeConfiguration<RsDelImItemPrompt>
    {
        public void Configure(EntityTypeBuilder<RsDelImItemPrompt> builder)
        {
            builder.ToTable("RS_DEL_IM_ITEM_PROMPT", "dbo");
            builder.HasKey(x => x.DelId).HasName("PK_RS_DEL_IM_ITEM_PROMPT").IsClustered();
