...
{
    // PS_DOC_PMT_RCPT
    public class PsDocPmtRcptConfiguration : IEntityTypeConfiguration<PsDocPmtRcpt>
    {
        public void Configure(EntityTypeBuilder<PsDocPmtRcpt> builder)
        {
            builder.ToTable("PS_DOC_PMT_RCPT", "dbo");
            builder.HasKey(x => new { x.DocId, x.PmtSeqNo }).HasName("PK_PS_DOC_PMT_RCPT").IsClustered();
            ...
            // Foreign keys
            builder.HasOne(a => a.PsDocPmt).WithOne(b => b.PsDocPmtRcpt).HasForeignKey<PsDocPmtRcpt>(c => new { c.DocId, c.PmtSeqNo }).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_PS_DOC_PMT_RCPT_PS_DOC_PMT");
        }
    }
