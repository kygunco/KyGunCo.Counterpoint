...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class PsLwyHistAuditLogConfiguration : IEntityTypeConfiguration<PsLwyHistAuditLog>
    {
        public void Configure(EntityTypeBuilder<PsLwyHistAuditLog> builder)
        {
            builder.ToTable("PS_LWY_HIST_AUDIT_LOG", "dbo");
            builder.HasKey(x => new { x.BusDat, x.DocId, x.LogSeqNo }).HasName("PK_PS_LWY_HIST_AUDIT_LOG").IsClustered();
            ...
            // Foreign keys
            builder.HasOne(a => a.PsLwyHist).WithMany(b => b.PsLwyHistAuditLogs).HasForeignKey(c => new { c.BusDat, c.DocId }).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_PS_LWY_HIST_AUDIT_LOG_PS_LWY_HIST");
        }
    }
