...
{
    // IM_HOT_COLD_RPT_WRK_GRPS
    public class ImHotColdRptWrkGrpConfiguration : IEntityTypeConfiguration<ImHotColdRptWrkGrp>
    {
        public void Configure(EntityTypeBuilder<ImHotColdRptWrkGrp> builder)
        {
            builder.ToTable("IM_HOT_COLD_RPT_WRK_GRPS", "dbo");
            builder.HasKey(x => new { x.SessId, x.GrpId }).HasName("PK_IM_HOT_COLD_RPT_WRK_GRPS").IsClustered();
            ...
            builder.Property(x => x.Rank).HasColumnName(@"RANK").HasColumnType("int").IsRequired(false);
