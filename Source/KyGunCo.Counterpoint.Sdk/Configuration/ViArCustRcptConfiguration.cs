...
{
    // VI_AR_CUST_RCPT
    public class ViArCustRcptConfiguration : IEntityTypeConfiguration<ViArCustRcpt>
    {
        public void Configure(EntityTypeBuilder<ViArCustRcpt> builder)
        {
            builder.ToView("VI_AR_CUST_RCPT", "dbo");
            builder.HasNoKey();
