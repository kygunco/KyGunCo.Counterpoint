...
{
    // VI_DM_SAL_STR_ITEM_DAY
    public class ViDmSalStrItemDayConfiguration : IEntityTypeConfiguration<ViDmSalStrItemDay>
    {
        public void Configure(EntityTypeBuilder<ViDmSalStrItemDay> builder)
        {
            builder.ToView("VI_DM_SAL_STR_ITEM_DAY", "dbo");
            builder.HasNoKey();
