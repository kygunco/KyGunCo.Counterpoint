...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class RsDelPsStaCfgPConfiguration : IEntityTypeConfiguration<RsDelPsStaCfgP>
    {
        public void Configure(EntityTypeBuilder<RsDelPsStaCfgP> builder)
        {
            builder.ToTable("RS_DEL_PS_STA_CFG_PS", "dbo");
            builder.HasKey(x => x.DelId).HasName("PK_RS_DEL_PS_STA_CFG_PS").IsClustered();
