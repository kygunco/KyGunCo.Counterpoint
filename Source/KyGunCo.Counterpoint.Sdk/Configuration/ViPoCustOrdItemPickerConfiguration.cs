...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViPoCustOrdItemPickerConfiguration : IEntityTypeConfiguration<ViPoCustOrdItemPicker>
    {
        public void Configure(EntityTypeBuilder<ViPoCustOrdItemPicker> builder)
        {
            builder.ToView("VI_PO_CUST_ORD_ITEM_PICKER", "dbo");
            builder.HasNoKey();
            ...
            builder.Property(x => x.OrdNo).HasColumnName(@"ORD_NO").HasColumnType("varchar(15)").IsRequired().IsUnicode(false).HasMaxLength(15);
            ...
            builder.Property(x => x.InvLstCost).HasColumnName(@"INV_LST_COST").HasColumnType("decimal(15,4)").IsRequired();
            ...
            builder.Property(x => x.InvLstRecvDat).HasColumnName(@"INV_LST_RECV_DAT").HasColumnType("datetime").IsRequired(false);
            ...
            builder.Property(x => x.PoVendItemNo).HasColumnName(@"PO_VEND_ITEM_NO").HasColumnType("varchar(30)").IsRequired(false).IsUnicode(false).HasMaxLength(30);
            ...
            builder.Property(x => x.PoLstOrdDat).HasColumnName(@"PO_LST_ORD_DAT").HasColumnType("datetime").IsRequired(false);
            ...
            builder.Property(x => x.LstOrdIsCancld).HasColumnName(@"LST_ORD_IS_CANCLD").HasColumnType("varchar(1)").IsRequired(false).IsUnicode(false).HasMaxLength(1);
            ...
            builder.Property(x => x.PoLstRecvDat).HasColumnName(@"PO_LST_RECV_DAT").HasColumnType("datetime").IsRequired(false);
