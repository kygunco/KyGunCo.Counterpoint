...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class PsVoidHistLinPriceConfiguration : IEntityTypeConfiguration<PsVoidHistLinPrice>
    {
        public void Configure(EntityTypeBuilder<PsVoidHistLinPrice> builder)
        {
            builder.ToTable("PS_VOID_HIST_LIN_PRICE", "dbo");
            builder.HasKey(x => new { x.BusDat, x.DocId, x.LinSeqNo, x.PrcSeqNo }).HasName("PK_PS_VOID_HIST_LIN_PRICE").IsClustered();
            ...
            // Foreign keys
            builder.HasOne(a => a.PsVoidHistLin).WithMany(b => b.PsVoidHistLinPrices).HasForeignKey(c => new { c.BusDat, c.DocId, c.LinSeqNo }).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_PS_VOID_HIST_LIN_PRICE_PS_VOID_HIST_LIN");
        }
    }
