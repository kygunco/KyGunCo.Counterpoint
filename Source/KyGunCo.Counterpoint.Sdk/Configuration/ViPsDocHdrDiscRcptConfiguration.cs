...
{
    // VI_PS_DOC_HDR_DISC_RCPT
    public class ViPsDocHdrDiscRcptConfiguration : IEntityTypeConfiguration<ViPsDocHdrDiscRcpt>
    {
        public void Configure(EntityTypeBuilder<ViPsDocHdrDiscRcpt> builder)
        {
            builder.ToView("VI_PS_DOC_HDR_DISC_RCPT", "dbo");
            builder.HasNoKey();
