...
{
    // IM_ITEM_PURGE_WRK
    public class ImItemPurgeWrkConfiguration : IEntityTypeConfiguration<ImItemPurgeWrk>
    {
        public void Configure(EntityTypeBuilder<ImItemPurgeWrk> builder)
        {
            builder.ToTable("IM_ITEM_PURGE_WRK", "dbo");
            builder.HasKey(x => new { x.SessId, x.ItemNo }).HasName("PK_IM_ITEM_PURGE_WRK").IsClustered();
