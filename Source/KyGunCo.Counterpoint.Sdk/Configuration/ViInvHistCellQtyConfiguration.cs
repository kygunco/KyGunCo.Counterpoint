...
{
    // VI_INV_HIST_CELL_QTY
    public class ViInvHistCellQtyConfiguration : IEntityTypeConfiguration<ViInvHistCellQty>
    {
        public void Configure(EntityTypeBuilder<ViInvHistCellQty> builder)
        {
            builder.ToView("VI_INV_HIST_CELL_QTY", "dbo");
            builder.HasNoKey();
