...
{
    // VI_PS_VOID_HIST_PMT
    public class ViPsVoidHistPmtConfiguration : IEntityTypeConfiguration<ViPsVoidHistPmt>
    {
        public void Configure(EntityTypeBuilder<ViPsVoidHistPmt> builder)
        {
            builder.ToView("VI_PS_VOID_HIST_PMT", "dbo");
            builder.HasNoKey();
