...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViImXferReconCellConfiguration : IEntityTypeConfiguration<ViImXferReconCell>
    {
        public void Configure(EntityTypeBuilder<ViImXferReconCell> builder)
        {
            builder.ToView("VI_IM_XFER_RECON_CELL", "dbo");
            builder.HasNoKey();
