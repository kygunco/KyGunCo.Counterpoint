...
{
    // VI_SY_DIST_DIST_TYP
    public class ViSyDistDistTypConfiguration : IEntityTypeConfiguration<ViSyDistDistTyp>
    {
        public void Configure(EntityTypeBuilder<ViSyDistDistTyp> builder)
        {
            builder.ToView("VI_SY_DIST_DIST_TYP", "dbo");
            builder.HasNoKey();
