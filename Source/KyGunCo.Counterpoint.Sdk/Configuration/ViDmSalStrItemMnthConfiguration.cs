...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViDmSalStrItemMnthConfiguration : IEntityTypeConfiguration<ViDmSalStrItemMnth>
    {
        public void Configure(EntityTypeBuilder<ViDmSalStrItemMnth> builder)
        {
            builder.ToView("VI_DM_SAL_STR_ITEM_MNTH", "dbo");
            builder.HasNoKey();
