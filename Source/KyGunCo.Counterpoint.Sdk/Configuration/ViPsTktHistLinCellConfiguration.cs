...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViPsTktHistLinCellConfiguration : IEntityTypeConfiguration<ViPsTktHistLinCell>
    {
        public void Configure(EntityTypeBuilder<ViPsTktHistLinCell> builder)
        {
            builder.ToView("VI_PS_TKT_HIST_LIN_CELL", "dbo");
            builder.HasNoKey();
