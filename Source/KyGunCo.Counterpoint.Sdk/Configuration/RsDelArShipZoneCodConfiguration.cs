...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class RsDelArShipZoneCodConfiguration : IEntityTypeConfiguration<RsDelArShipZoneCod>
    {
        public void Configure(EntityTypeBuilder<RsDelArShipZoneCod> builder)
        {
            builder.ToTable("RS_DEL_AR_SHIP_ZONE_COD", "dbo");
            builder.HasKey(x => x.DelId).HasName("PK_RS_DEL_AR_SHIP_ZONE_COD").IsClustered();
