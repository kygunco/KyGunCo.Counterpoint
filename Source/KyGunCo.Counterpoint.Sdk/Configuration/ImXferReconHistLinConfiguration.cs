...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ImXferReconHistLinConfiguration : IEntityTypeConfiguration<ImXferReconHistLin>
    {
        public void Configure(EntityTypeBuilder<ImXferReconHistLin> builder)
        {
            builder.ToTable("IM_XFER_RECON_HIST_LIN", "dbo");
            builder.HasKey(x => new { x.XferNo, x.XferLinSeqNo }).HasName("PK_IM_XFER_RECON_HIST_LIN").IsClustered();
            ...
            // Foreign keys
            builder.HasOne(a => a.ImXferReconHist).WithMany(b => b.ImXferReconHistLins).HasForeignKey(c => c.XferNo).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_IM_XFER_RECON_HIST_LIN_IM_XFER_RECON_HIST");

            builder.HasIndex(x => new { x.ItemNo, x.XferNo, x.XferLinSeqNo }).HasDatabaseName("IM_XFER_RECON_HIST_LIN_X1");
            builder.HasIndex(x => new { x.ItemDescrUpr, x.XferNo, x.XferLinSeqNo }).HasDatabaseName("IM_XFER_RECON_HIST_LIN_X2");
        }
    }
