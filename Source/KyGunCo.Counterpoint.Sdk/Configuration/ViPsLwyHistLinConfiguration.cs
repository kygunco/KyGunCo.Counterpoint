...
{
    // VI_PS_LWY_HIST_LIN
    public class ViPsLwyHistLinConfiguration : IEntityTypeConfiguration<ViPsLwyHistLin>
    {
        public void Configure(EntityTypeBuilder<ViPsLwyHistLin> builder)
        {
            builder.ToView("VI_PS_LWY_HIST_LIN", "dbo");
            builder.HasNoKey();
