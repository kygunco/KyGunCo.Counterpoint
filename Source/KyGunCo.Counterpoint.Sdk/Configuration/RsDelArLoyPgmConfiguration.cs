...
{
    // RS_DEL_AR_LOY_PGM
    public class RsDelArLoyPgmConfiguration : IEntityTypeConfiguration<RsDelArLoyPgm>
    {
        public void Configure(EntityTypeBuilder<RsDelArLoyPgm> builder)
        {
            builder.ToTable("RS_DEL_AR_LOY_PGM", "dbo");
            builder.HasKey(x => x.DelId).HasName("PK_RS_DEL_AR_LOY_PGM").IsClustered();
