...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViPsVoidHistLinDiscRcptConfiguration : IEntityTypeConfiguration<ViPsVoidHistLinDiscRcpt>
    {
        public void Configure(EntityTypeBuilder<ViPsVoidHistLinDiscRcpt> builder)
        {
            builder.ToView("VI_PS_VOID_HIST_LIN_DISC_RCPT", "dbo");
            builder.HasNoKey();
