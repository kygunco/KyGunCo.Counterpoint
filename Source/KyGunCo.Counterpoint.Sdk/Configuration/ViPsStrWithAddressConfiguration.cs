...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViPsStrWithAddressConfiguration : IEntityTypeConfiguration<ViPsStrWithAddress>
    {
        public void Configure(EntityTypeBuilder<ViPsStrWithAddress> builder)
        {
            builder.ToView("VI_PS_STR_WITH_ADDRESS", "dbo");
            builder.HasNoKey();
            ...
            builder.Property(x => x.LblName).HasColumnName(@"LBL_NAME").HasColumnType("varchar(50)").IsRequired().IsUnicode(false).HasMaxLength(50);
