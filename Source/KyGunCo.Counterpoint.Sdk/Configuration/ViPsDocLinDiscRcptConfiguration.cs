...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViPsDocLinDiscRcptConfiguration : IEntityTypeConfiguration<ViPsDocLinDiscRcpt>
    {
        public void Configure(EntityTypeBuilder<ViPsDocLinDiscRcpt> builder)
        {
            builder.ToView("VI_PS_DOC_LIN_DISC_RCPT", "dbo");
            builder.HasNoKey();
