...
{
    // USER_VI_FFL_INFO
    public class UserViFflInfoConfiguration : IEntityTypeConfiguration<UserViFflInfo>
    {
        public void Configure(EntityTypeBuilder<UserViFflInfo> builder)
        {
            builder.ToView("USER_VI_FFL_INFO", "dbo");
            builder.HasNoKey();
            ...
            builder.Property(x => x.FullFfl).HasColumnName(@"FullFFL").HasColumnType("varchar(8000)").IsRequired(false).IsUnicode(false).HasMaxLength(8000);
