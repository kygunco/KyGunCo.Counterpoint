...
{
    // VI_PS_ORD_HIST_LIN_SER
    public class ViPsOrdHistLinSerConfiguration : IEntityTypeConfiguration<ViPsOrdHistLinSer>
    {
        public void Configure(EntityTypeBuilder<ViPsOrdHistLinSer> builder)
        {
            builder.ToView("VI_PS_ORD_HIST_LIN_SER", "dbo");
            builder.HasNoKey();
