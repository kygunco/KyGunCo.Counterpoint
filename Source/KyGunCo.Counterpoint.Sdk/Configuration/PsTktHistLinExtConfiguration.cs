...
{
    // PS_TKT_HIST_LIN_EXT
    public class PsTktHistLinExtConfiguration : IEntityTypeConfiguration<PsTktHistLinExt>
    {
        public void Configure(EntityTypeBuilder<PsTktHistLinExt> builder)
        {
            builder.ToTable("PS_TKT_HIST_LIN_EXT", "dbo");
            builder.HasKey(x => new { x.BusDatExt, x.DocIdExt, x.LinSeqNoExt }).HasName("PK_PS_TKT_HIST_LIN_EXT").IsClustered();
