...
{
    // VI_PS_LWY_HIST_DISC
    public class ViPsLwyHistDiscConfiguration : IEntityTypeConfiguration<ViPsLwyHistDisc>
    {
        public void Configure(EntityTypeBuilder<ViPsLwyHistDisc> builder)
        {
            builder.ToView("VI_PS_LWY_HIST_DISC", "dbo");
            builder.HasNoKey();
