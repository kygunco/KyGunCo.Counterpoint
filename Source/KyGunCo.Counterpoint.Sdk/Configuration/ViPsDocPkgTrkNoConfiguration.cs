...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViPsDocPkgTrkNoConfiguration : IEntityTypeConfiguration<ViPsDocPkgTrkNo>
    {
        public void Configure(EntityTypeBuilder<ViPsDocPkgTrkNo> builder)
        {
            builder.ToView("VI_PS_DOC_PKG_TRK_NO", "dbo");
            builder.HasNoKey();
