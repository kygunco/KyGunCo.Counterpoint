...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class PsDocLinSerPromptConfiguration : IEntityTypeConfiguration<PsDocLinSerPrompt>
    {
        public void Configure(EntityTypeBuilder<PsDocLinSerPrompt> builder)
        {
            builder.ToTable("PS_DOC_LIN_SER_PROMPT", "dbo");
            builder.HasKey(x => new { x.DocId, x.LinSeqNo, x.SerNo, x.PromptSeqNo }).HasName("PK_PS_DOC_LIN_SER_PROMPT").IsClustered();
            ...
            // Foreign keys
            builder.HasOne(a => a.PsDocLinSer).WithMany(b => b.PsDocLinSerPrompts).HasForeignKey(c => new { c.DocId, c.LinSeqNo, c.SerNo }).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_PS_DOC_LIN_SER_PROMPT_PS_DOC_LIN_SER");
        }
    }
