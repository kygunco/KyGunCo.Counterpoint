...
{
    // VI_IM_ITEM_WITH_INV
    public class ViImItemWithInvConfiguration : IEntityTypeConfiguration<ViImItemWithInv>
    {
        public void Configure(EntityTypeBuilder<ViImItemWithInv> builder)
        {
            builder.ToView("VI_IM_ITEM_WITH_INV", "dbo");
            builder.HasNoKey();
