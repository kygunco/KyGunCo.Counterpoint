...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class PsVoidHistPmtPromptConfiguration : IEntityTypeConfiguration<PsVoidHistPmtPrompt>
    {
        public void Configure(EntityTypeBuilder<PsVoidHistPmtPrompt> builder)
        {
            builder.ToTable("PS_VOID_HIST_PMT_PROMPT", "dbo");
            builder.HasKey(x => new { x.BusDat, x.DocId, x.PmtSeqNo, x.PromptSeqNo }).HasName("PK_PS_VOID_HIST_PMT_PROMPT").IsClustered();
            ...
            // Foreign keys
            builder.HasOne(a => a.PsVoidHistPmt).WithMany(b => b.PsVoidHistPmtPrompts).HasForeignKey(c => new { c.BusDat, c.DocId, c.PmtSeqNo }).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_PS_VOID_HIST_PMT_PROMPT_PS_VOID_HIST_PMT");
        }
    }
