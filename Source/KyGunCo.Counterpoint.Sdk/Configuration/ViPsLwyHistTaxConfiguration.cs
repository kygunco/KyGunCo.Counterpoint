...
{
    // VI_PS_LWY_HIST_TAX
    public class ViPsLwyHistTaxConfiguration : IEntityTypeConfiguration<ViPsLwyHistTax>
    {
        public void Configure(EntityTypeBuilder<ViPsLwyHistTax> builder)
        {
            builder.ToView("VI_PS_LWY_HIST_TAX", "dbo");
            builder.HasNoKey();
