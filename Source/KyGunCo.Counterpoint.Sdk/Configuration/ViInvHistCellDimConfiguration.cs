...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViInvHistCellDimConfiguration : IEntityTypeConfiguration<ViInvHistCellDim>
    {
        public void Configure(EntityTypeBuilder<ViInvHistCellDim> builder)
        {
            builder.ToView("VI_INV_HIST_CELL_DIMS", "dbo");
            builder.HasNoKey();
            ...
            builder.Property(x => x.ExtCost).HasColumnName(@"EXT_COST").HasColumnType("decimal(20,8)").IsRequired(false);
            builder.Property(x => x.ExtRet).HasColumnName(@"EXT_RET").HasColumnType("decimal(35,8)").IsRequired(false);
            builder.Property(x => x.TotCostCorr).HasColumnName(@"TOT_COST_CORR").HasColumnType("decimal(20,8)").IsRequired(false);
            ...
            builder.Property(x => x.UnitCost).HasColumnName(@"UNIT_COST").HasColumnType("decimal(38,11)").IsRequired(false);
