...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViDmExcptStrUsrDayConfiguration : IEntityTypeConfiguration<ViDmExcptStrUsrDay>
    {
        public void Configure(EntityTypeBuilder<ViDmExcptStrUsrDay> builder)
        {
            builder.ToView("VI_DM_EXCPT_STR_USR_DAY", "dbo");
            builder.HasNoKey();
            ...
            builder.Property(x => x.TktCnt).HasColumnName(@"TKT_CNT").HasColumnType("int").IsRequired(false);
            builder.Property(x => x.TktAmt).HasColumnName(@"TKT_AMT").HasColumnType("money").IsRequired(false);
            builder.Property(x => x.LinCnt).HasColumnName(@"LIN_CNT").HasColumnType("int").IsRequired(false);
            builder.Property(x => x.OvrShrt).HasColumnName(@"OVR_SHRT").HasColumnType("decimal(15,2)").IsRequired(false);
            builder.Property(x => x.HoursWrkd).HasColumnName(@"HOURS_WRKD").HasColumnType("money").IsRequired(false);
