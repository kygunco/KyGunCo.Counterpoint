...
{
    // USER_VI_IM_ITEM
    public class UserViImItemConfiguration : IEntityTypeConfiguration<UserViImItem>
    {
        public void Configure(EntityTypeBuilder<UserViImItem> builder)
        {
            builder.ToView("USER_VI_IM_ITEM", "dbo");
            builder.HasNoKey();
            ...
            builder.Property(x => x.KitQtyAvail).HasColumnName(@"KIT_QTY_AVAIL").HasColumnType("decimal(36,0)").IsRequired(false);
            builder.Property(x => x.KitQtyOnHnd).HasColumnName(@"KIT_QTY_ON_HND").HasColumnType("decimal(35,0)").IsRequired(false);
            builder.Property(x => x.Prc2).HasColumnName(@"PRC_2").HasColumnType("decimal(15,4)").IsRequired(false);
            builder.Property(x => x.Alt1SalePrc).HasColumnName(@"ALT_1_SALE_PRC").HasColumnType("decimal(15,4)").IsRequired(false);
            builder.Property(x => x.Alt2SalePrc).HasColumnName(@"ALT_2_SALE_PRC").HasColumnType("decimal(15,4)").IsRequired(false);
            builder.Property(x => x.Alt3SalePrc).HasColumnName(@"ALT_3_SALE_PRC").HasColumnType("decimal(15,4)").IsRequired(false);
            builder.Property(x => x.Alt4SalePrc).HasColumnName(@"ALT_4_SALE_PRC").HasColumnType("decimal(15,4)").IsRequired(false);
            builder.Property(x => x.Alt5SalePrc).HasColumnName(@"ALT_5_SALE_PRC").HasColumnType("decimal(15,4)").IsRequired(false);
        }
    }
