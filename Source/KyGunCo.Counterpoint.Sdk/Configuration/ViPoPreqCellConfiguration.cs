...
{
    // VI_PO_PREQ_CELL
    public class ViPoPreqCellConfiguration : IEntityTypeConfiguration<ViPoPreqCell>
    {
        public void Configure(EntityTypeBuilder<ViPoPreqCell> builder)
        {
            builder.ToView("VI_PO_PREQ_CELL", "dbo");
            builder.HasNoKey();
