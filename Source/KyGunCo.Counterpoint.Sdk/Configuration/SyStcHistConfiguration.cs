...
{
    // SY_STC_HIST
    public class SyStcHistConfiguration : IEntityTypeConfiguration<SyStcHist>
    {
        public void Configure(EntityTypeBuilder<SyStcHist> builder)
        {
            builder.ToTable("SY_STC_HIST", "dbo");
            builder.HasKey(x => new { x.EventNo, x.StcNo }).HasName("PK_SY_STC_HIST").IsClustered();
            ...
            builder.HasIndex(x => new { x.DescrUpr, x.EventNo, x.StcNo }).HasDatabaseName("SY_STC_HIST_X1");
            builder.HasIndex(x => new { x.OrigCustNo, x.EventNo, x.StcNo }).HasDatabaseName("SY_STC_HIST_X2");
            builder.HasIndex(x => new { x.ExpDat, x.EventNo, x.StcNo }).HasDatabaseName("SY_STC_HIST_X3");
        }
    }
