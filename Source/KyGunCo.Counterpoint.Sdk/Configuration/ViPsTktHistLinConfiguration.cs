...
{
    // VI_PS_TKT_HIST_LIN
    public class ViPsTktHistLinConfiguration : IEntityTypeConfiguration<ViPsTktHistLin>
    {
        public void Configure(EntityTypeBuilder<ViPsTktHistLin> builder)
        {
            builder.ToView("VI_PS_TKT_HIST_LIN", "dbo");
            builder.HasNoKey();
            ...
            builder.Property(x => x.IsScrapRetLin).HasColumnName(@"IS_SCRAP_RET_LIN").HasColumnType("varchar(1)").IsRequired().IsUnicode(false).HasMaxLength(1);
            ...
            builder.Property(x => x.ExtCalcPrc).HasColumnName(@"EXT_CALC_PRC").HasColumnType("decimal(15,2)").IsRequired();
            builder.Property(x => x.GrsPft).HasColumnName(@"GRS_PFT").HasColumnType("decimal(16,2)").IsRequired(false);
            ...
            builder.Property(x => x.UnitRetlAtPostDisc).HasColumnName(@"UNIT_RETL_AT_POST_DISC").HasColumnType("money").IsRequired(false);
            builder.Property(x => x.UnitRetlAtPostDiscPct).HasColumnName(@"UNIT_RETL_AT_POST_DISC_PCT").HasColumnType("numeric(38,14)").IsRequired(false);
            ...
            builder.Property(x => x.UserTaxAmtAlloc).HasColumnName(@"USER_TAX_AMT_ALLOC").HasColumnType("decimal(15,2)").IsRequired(false);
            ...
            builder.Property(x => x.CompExtCost).HasColumnName(@"COMP_EXT_COST").HasColumnType("decimal(38,2)").IsRequired(false);
            builder.Property(x => x.CompExtPrc).HasColumnName(@"COMP_EXT_PRC").HasColumnType("decimal(38,2)").IsRequired(false);
        }
    }
