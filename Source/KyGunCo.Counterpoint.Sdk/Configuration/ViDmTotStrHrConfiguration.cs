...
{
    // VI_DM_TOT_STR_HR
    public class ViDmTotStrHrConfiguration : IEntityTypeConfiguration<ViDmTotStrHr>
    {
        public void Configure(EntityTypeBuilder<ViDmTotStrHr> builder)
        {
            builder.ToView("VI_DM_TOT_STR_HR", "dbo");
            builder.HasNoKey();
            ...
            builder.Property(x => x.HrId).HasColumnName(@"HR_ID").HasColumnType("tinyint").IsRequired();
