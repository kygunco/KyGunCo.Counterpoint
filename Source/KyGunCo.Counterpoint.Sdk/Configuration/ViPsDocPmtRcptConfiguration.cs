...
{
    // VI_PS_DOC_PMT_RCPT
    public class ViPsDocPmtRcptConfiguration : IEntityTypeConfiguration<ViPsDocPmtRcpt>
    {
        public void Configure(EntityTypeBuilder<ViPsDocPmtRcpt> builder)
        {
            builder.ToView("VI_PS_DOC_PMT_RCPT", "dbo");
            builder.HasNoKey();
