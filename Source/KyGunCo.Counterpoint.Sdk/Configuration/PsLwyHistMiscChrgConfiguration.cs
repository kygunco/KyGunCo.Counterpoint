...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class PsLwyHistMiscChrgConfiguration : IEntityTypeConfiguration<PsLwyHistMiscChrg>
    {
        public void Configure(EntityTypeBuilder<PsLwyHistMiscChrg> builder)
        {
            builder.ToTable("PS_LWY_HIST_MISC_CHRG", "dbo");
            builder.HasKey(x => new { x.BusDat, x.DocId, x.MiscChrgNo }).HasName("PK_PS_LWY_HIST_MISC_CHRG").IsClustered();
            ...
            // Foreign keys
            builder.HasOne(a => a.PsLwyHist).WithMany(b => b.PsLwyHistMiscChrgs).HasForeignKey(c => new { c.BusDat, c.DocId }).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_PS_LWY_HIST_MISC_CHRG_PS_LWY_HIST");
        }
    }
