...
{
    // VI_TKT_HIST_STA
    public class ViTktHistStaConfiguration : IEntityTypeConfiguration<ViTktHistSta>
    {
        public void Configure(EntityTypeBuilder<ViTktHistSta> builder)
        {
            builder.ToView("VI_TKT_HIST_STA", "dbo");
            builder.HasNoKey();

            builder.Property(x => x.StrId).HasColumnName(@"STR_ID").HasColumnType("varchar(10)").IsRequired().IsUnicode(false).HasMaxLength(10);
            builder.Property(x => x.StrDescr).HasColumnName(@"STR_DESCR").HasColumnType("varchar(50)").IsRequired(false).IsUnicode(false).HasMaxLength(50);
