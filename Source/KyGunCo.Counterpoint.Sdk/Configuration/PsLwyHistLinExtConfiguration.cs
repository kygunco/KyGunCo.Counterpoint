...
{
    // PS_LWY_HIST_LIN_EXT
    public class PsLwyHistLinExtConfiguration : IEntityTypeConfiguration<PsLwyHistLinExt>
    {
        public void Configure(EntityTypeBuilder<PsLwyHistLinExt> builder)
        {
            builder.ToTable("PS_LWY_HIST_LIN_EXT", "dbo");
            builder.HasKey(x => new { x.BusDatExt, x.DocIdExt, x.LinSeqNoExt }).HasName("PK_PS_LWY_HIST_LIN_EXT").IsClustered();
            ...
            // Foreign keys
            builder.HasOne(a => a.PsLwyHistLin).WithOne(b => b.PsLwyHistLinExt).HasForeignKey<PsLwyHistLinExt>(c => new { c.BusDatExt, c.DocIdExt, c.LinSeqNoExt }).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_PS_LWY_HIST_LIN_EXT_PS_LWY_HIST_LIN");
        }
    }
