...
{
    // VI_PS_ORD_HIST_PKG_TRK_NO
    public class ViPsOrdHistPkgTrkNoConfiguration : IEntityTypeConfiguration<ViPsOrdHistPkgTrkNo>
    {
        public void Configure(EntityTypeBuilder<ViPsOrdHistPkgTrkNo> builder)
        {
            builder.ToView("VI_PS_ORD_HIST_PKG_TRK_NO", "dbo");
            builder.HasNoKey();
