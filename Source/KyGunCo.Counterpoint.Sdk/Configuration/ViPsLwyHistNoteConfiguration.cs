...
{
    // VI_PS_LWY_HIST_NOTE
    public class ViPsLwyHistNoteConfiguration : IEntityTypeConfiguration<ViPsLwyHistNote>
    {
        public void Configure(EntityTypeBuilder<ViPsLwyHistNote> builder)
        {
            builder.ToView("VI_PS_LWY_HIST_NOTE", "dbo");
            builder.HasNoKey();
