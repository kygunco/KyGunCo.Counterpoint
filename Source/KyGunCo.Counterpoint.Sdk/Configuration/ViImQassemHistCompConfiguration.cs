...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViImQassemHistCompConfiguration : IEntityTypeConfiguration<ViImQassemHistComp>
    {
        public void Configure(EntityTypeBuilder<ViImQassemHistComp> builder)
        {
            builder.ToView("VI_IM_QASSEM_HIST_COMP", "dbo");
            builder.HasNoKey();
