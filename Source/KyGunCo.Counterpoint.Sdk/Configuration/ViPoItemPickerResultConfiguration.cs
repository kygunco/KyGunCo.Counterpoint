...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViPoItemPickerResultConfiguration : IEntityTypeConfiguration<ViPoItemPickerResult>
    {
        public void Configure(EntityTypeBuilder<ViPoItemPickerResult> builder)
        {
            builder.ToView("VI_PO_ITEM_PICKER_RESULTS", "dbo");
            builder.HasNoKey();
            ...
            builder.Property(x => x.OrdUnit).HasColumnName(@"ORD_UNIT").HasColumnType("varchar(15)").IsRequired().IsUnicode(false).HasMaxLength(15);
            builder.Property(x => x.OrdQtyUnit).HasColumnName(@"ORD_QTY_UNIT").HasColumnType("int").IsRequired();
            builder.Property(x => x.OrdQtyNumer).HasColumnName(@"ORD_QTY_NUMER").HasColumnType("int").IsRequired();
            builder.Property(x => x.OrdQtyDenom).HasColumnName(@"ORD_QTY_DENOM").HasColumnType("int").IsRequired();
            ...
            builder.Property(x => x.InvLstCost).HasColumnName(@"INV_LST_COST").HasColumnType("decimal(15,4)").IsRequired(false);
            builder.Property(x => x.UnitRetlVal).HasColumnName(@"UNIT_RETL_VAL").HasColumnType("decimal(15,4)").IsRequired(false);
            builder.Property(x => x.ExtAvgCost).HasColumnName(@"EXT_AVG_COST").HasColumnType("decimal(31,8)").IsRequired(false);
            builder.Property(x => x.ExtLstCost).HasColumnName(@"EXT_LST_COST").HasColumnType("decimal(31,8)").IsRequired(false);
            builder.Property(x => x.ExtRetlPrc).HasColumnName(@"EXT_RETL_PRC").HasColumnType("decimal(31,8)").IsRequired(false);
            ...
            builder.Property(x => x.ExtVendItemCost).HasColumnName(@"EXT_VEND_ITEM_COST").HasColumnType("decimal(31,8)").IsRequired(false);
