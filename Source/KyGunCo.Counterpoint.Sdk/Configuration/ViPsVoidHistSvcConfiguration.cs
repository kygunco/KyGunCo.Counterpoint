...
{
    // VI_PS_VOID_HIST_SVC
    public class ViPsVoidHistSvcConfiguration : IEntityTypeConfiguration<ViPsVoidHistSvc>
    {
        public void Configure(EntityTypeBuilder<ViPsVoidHistSvc> builder)
        {
            builder.ToView("VI_PS_VOID_HIST_SVC", "dbo");
            builder.HasNoKey();
