...
{
    // VI_IM_CELL_PRC_1
    public class ViImCellPrc1Configuration : IEntityTypeConfiguration<ViImCellPrc1>
    {
        public void Configure(EntityTypeBuilder<ViImCellPrc1> builder)
        {
            builder.ToView("VI_IM_CELL_PRC_1", "dbo");
            builder.HasNoKey();
