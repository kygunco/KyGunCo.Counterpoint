...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViPsVoidHistLinCellConfiguration : IEntityTypeConfiguration<ViPsVoidHistLinCell>
    {
        public void Configure(EntityTypeBuilder<ViPsVoidHistLinCell> builder)
        {
            builder.ToView("VI_PS_VOID_HIST_LIN_CELL", "dbo");
            builder.HasNoKey();
