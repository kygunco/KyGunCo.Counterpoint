...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class PsLwyHistHoldQuotConfiguration : IEntityTypeConfiguration<PsLwyHistHoldQuot>
    {
        public void Configure(EntityTypeBuilder<PsLwyHistHoldQuot> builder)
        {
            builder.ToTable("PS_LWY_HIST_HOLD_QUOT", "dbo");
            builder.HasKey(x => new { x.BusDat, x.DocId }).HasName("PK_PS_LWY_HIST_HOLD_QUOT").IsClustered();
            ...
            // Foreign keys
            builder.HasOne(a => a.PsLwyHist).WithOne(b => b.PsLwyHistHoldQuot).HasForeignKey<PsLwyHistHoldQuot>(c => new { c.BusDat, c.DocId }).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_PS_LWY_HIST_HOLD_QUOT_PS_LWY_HIST");
        }
    }
