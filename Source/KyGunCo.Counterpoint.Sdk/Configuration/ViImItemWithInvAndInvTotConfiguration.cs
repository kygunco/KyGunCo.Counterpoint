...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViImItemWithInvAndInvTotConfiguration : IEntityTypeConfiguration<ViImItemWithInvAndInvTot>
    {
        public void Configure(EntityTypeBuilder<ViImItemWithInvAndInvTot> builder)
        {
            builder.ToView("VI_IM_ITEM_WITH_INV_AND_INV_TOTS", "dbo");
            builder.HasNoKey();
            ...
            builder.Property(x => x.ItemMinQty).HasColumnName(@"ITEM_MIN_QTY").HasColumnType("decimal(38,4)").IsRequired(false);
            builder.Property(x => x.ItemMaxQty).HasColumnName(@"ITEM_MAX_QTY").HasColumnType("decimal(38,4)").IsRequired(false);
            builder.Property(x => x.ItemQtyCommit).HasColumnName(@"ITEM_QTY_COMMIT").HasColumnType("decimal(38,4)").IsRequired(false);
            builder.Property(x => x.ItemQtyOnHnd).HasColumnName(@"ITEM_QTY_ON_HND").HasColumnType("decimal(38,4)").IsRequired(false);
            builder.Property(x => x.ItemQtyOnPo).HasColumnName(@"ITEM_QTY_ON_PO").HasColumnType("decimal(38,4)").IsRequired(false);
            builder.Property(x => x.ItemQtyOnBo).HasColumnName(@"ITEM_QTY_ON_BO").HasColumnType("decimal(38,4)").IsRequired(false);
            builder.Property(x => x.ItemQtyOnXferOut).HasColumnName(@"ITEM_QTY_ON_XFER_OUT").HasColumnType("decimal(38,4)").IsRequired(false);
            builder.Property(x => x.ItemQtyOnXferIn).HasColumnName(@"ITEM_QTY_ON_XFER_IN").HasColumnType("decimal(38,4)").IsRequired(false);
            builder.Property(x => x.ItemFstRecvDat).HasColumnName(@"ITEM_FST_RECV_DAT").HasColumnType("datetime").IsRequired(false);
            builder.Property(x => x.ItemLstRecvDat).HasColumnName(@"ITEM_LST_RECV_DAT").HasColumnType("datetime").IsRequired(false);
            builder.Property(x => x.ItemFstSalDat).HasColumnName(@"ITEM_FST_SAL_DAT").HasColumnType("datetime").IsRequired(false);
            builder.Property(x => x.ItemLstSalDat).HasColumnName(@"ITEM_LST_SAL_DAT").HasColumnType("datetime").IsRequired(false);
            builder.Property(x => x.ItemLstCntDat).HasColumnName(@"ITEM_LST_CNT_DAT").HasColumnType("datetime").IsRequired(false);
            builder.Property(x => x.ItemLstOrdDat).HasColumnName(@"ITEM_LST_ORD_DAT").HasColumnType("datetime").IsRequired(false);
            builder.Property(x => x.ItemQtyOnOrd).HasColumnName(@"ITEM_QTY_ON_ORD").HasColumnType("decimal(38,4)").IsRequired(false);
            builder.Property(x => x.ItemQtyOnLwy).HasColumnName(@"ITEM_QTY_ON_LWY").HasColumnType("decimal(38,4)").IsRequired(false);
            builder.Property(x => x.ItemQtyOnSo).HasColumnName(@"ITEM_QTY_ON_SO").HasColumnType("decimal(38,4)").IsRequired(false);
            builder.Property(x => x.ItemQtyAvail).HasColumnName(@"ITEM_QTY_AVAIL").HasColumnType("decimal(38,4)").IsRequired(false);
            builder.Property(x => x.ItemDropshipQtyOnCustOrd).HasColumnName(@"ITEM_DROPSHIP_QTY_ON_CUST_ORD").HasColumnType("decimal(38,4)").IsRequired(false);
            builder.Property(x => x.ItemDropshipQtyOnPo).HasColumnName(@"ITEM_DROPSHIP_QTY_ON_PO").HasColumnType("decimal(38,4)").IsRequired(false);
            builder.Property(x => x.ItemNetQty).HasColumnName(@"ITEM_NET_QTY").HasColumnType("decimal(38,4)").IsRequired(false);
        }
    }
