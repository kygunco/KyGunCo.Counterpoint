...
{
    // IM_ITEM_PROF_COD
    public class ImItemProfCodConfiguration : IEntityTypeConfiguration<ImItemProfCod>
    {
        public void Configure(EntityTypeBuilder<ImItemProfCod> builder)
        {
            builder.ToTable("IM_ITEM_PROF_COD", "dbo");
            builder.HasKey(x => x.ProfCod).HasName("PK_IM_ITEM_PROF_COD").IsClustered();
            ...
            builder.HasIndex(x => x.RsStat).HasDatabaseName("IM_ITEM_PROF_COD_X_RS_STAT");
            builder.HasIndex(x => x.RsUtcDt).HasDatabaseName("IM_ITEM_PROF_COD_X_RS_UTC_DT");
            builder.HasIndex(x => new { x.DescrUpr, x.ProfCod }).HasDatabaseName("IM_ITEM_PROF_COD_X1");
        }
    }
