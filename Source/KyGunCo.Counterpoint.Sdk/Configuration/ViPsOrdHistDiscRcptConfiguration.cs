...
{
    // VI_PS_ORD_HIST_DISC_RCPT
    public class ViPsOrdHistDiscRcptConfiguration : IEntityTypeConfiguration<ViPsOrdHistDiscRcpt>
    {
        public void Configure(EntityTypeBuilder<ViPsOrdHistDiscRcpt> builder)
        {
            builder.ToView("VI_PS_ORD_HIST_DISC_RCPT", "dbo");
            builder.HasNoKey();
