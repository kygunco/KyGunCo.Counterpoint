...
{
    // VI_DM_TOT_STR_DAY
    public class ViDmTotStrDayConfiguration : IEntityTypeConfiguration<ViDmTotStrDay>
    {
        public void Configure(EntityTypeBuilder<ViDmTotStrDay> builder)
        {
            builder.ToView("VI_DM_TOT_STR_DAY", "dbo");
            builder.HasNoKey();
