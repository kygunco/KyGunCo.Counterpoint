...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViImXferInHistCellConfiguration : IEntityTypeConfiguration<ViImXferInHistCell>
    {
        public void Configure(EntityTypeBuilder<ViImXferInHistCell> builder)
        {
            builder.ToView("VI_IM_XFER_IN_HIST_CELL", "dbo");
            builder.HasNoKey();
