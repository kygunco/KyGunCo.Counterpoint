...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class RsDelImSerPromptConfiguration : IEntityTypeConfiguration<RsDelImSerPrompt>
    {
        public void Configure(EntityTypeBuilder<RsDelImSerPrompt> builder)
        {
            builder.ToTable("RS_DEL_IM_SER_PROMPT", "dbo");
            builder.HasKey(x => x.DelId).HasName("PK_RS_DEL_IM_SER_PROMPT").IsClustered();
