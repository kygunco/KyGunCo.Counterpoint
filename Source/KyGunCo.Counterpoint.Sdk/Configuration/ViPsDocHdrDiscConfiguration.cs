...
{
    // VI_PS_DOC_HDR_DISC
    public class ViPsDocHdrDiscConfiguration : IEntityTypeConfiguration<ViPsDocHdrDisc>
    {
        public void Configure(EntityTypeBuilder<ViPsDocHdrDisc> builder)
        {
            builder.ToView("VI_PS_DOC_HDR_DISC", "dbo");
            builder.HasNoKey();
