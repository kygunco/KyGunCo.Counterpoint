...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class PsVoidHistLinCellConfiguration : IEntityTypeConfiguration<PsVoidHistLinCell>
    {
        public void Configure(EntityTypeBuilder<PsVoidHistLinCell> builder)
        {
            builder.ToTable("PS_VOID_HIST_LIN_CELL", "dbo");
            builder.HasKey(x => new { x.BusDat, x.DocId, x.LinSeqNo, x.Dim1Upr, x.Dim2Upr, x.Dim3Upr }).HasName("PK_PS_VOID_HIST_LIN_CELL").IsClustered();
            ...
            // Foreign keys
            builder.HasOne(a => a.PsVoidHistLin).WithMany(b => b.PsVoidHistLinCells).HasForeignKey(c => new { c.BusDat, c.DocId, c.LinSeqNo }).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_PS_VOID_HIST_LIN_CELL_PS_VOID_HIST_LIN");
        }
    }
