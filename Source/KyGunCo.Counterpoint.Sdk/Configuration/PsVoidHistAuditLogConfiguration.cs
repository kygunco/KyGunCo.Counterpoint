...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class PsVoidHistAuditLogConfiguration : IEntityTypeConfiguration<PsVoidHistAuditLog>
    {
        public void Configure(EntityTypeBuilder<PsVoidHistAuditLog> builder)
        {
            builder.ToTable("PS_VOID_HIST_AUDIT_LOG", "dbo");
            builder.HasKey(x => new { x.BusDat, x.DocId, x.LogSeqNo }).HasName("PK_PS_VOID_HIST_AUDIT_LOG").IsClustered();
            ...
            // Foreign keys
            builder.HasOne(a => a.PsVoidHist).WithMany(b => b.PsVoidHistAuditLogs).HasForeignKey(c => new { c.BusDat, c.DocId }).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_PS_VOID_HIST_AUDIT_LOG_PS_VOID_HIST");
        }
    }
