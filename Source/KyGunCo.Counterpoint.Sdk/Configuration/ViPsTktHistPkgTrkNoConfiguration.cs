...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViPsTktHistPkgTrkNoConfiguration : IEntityTypeConfiguration<ViPsTktHistPkgTrkNo>
    {
        public void Configure(EntityTypeBuilder<ViPsTktHistPkgTrkNo> builder)
        {
            builder.ToView("VI_PS_TKT_HIST_PKG_TRK_NO", "dbo");
            builder.HasNoKey();
