...
{
    // VI_PS_DOC_GFC_RCPT
    public class ViPsDocGfcRcptConfiguration : IEntityTypeConfiguration<ViPsDocGfcRcpt>
    {
        public void Configure(EntityTypeBuilder<ViPsDocGfcRcpt> builder)
        {
            builder.ToView("VI_PS_DOC_GFC_RCPT", "dbo");
            builder.HasNoKey();
