...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViImQxferHistCellConfiguration : IEntityTypeConfiguration<ViImQxferHistCell>
    {
        public void Configure(EntityTypeBuilder<ViImQxferHistCell> builder)
        {
            builder.ToView("VI_IM_QXFER_HIST_CELL", "dbo");
            builder.HasNoKey();
