...
{
    // VI_PS_VOID_HIST_LIN_DISC
    public class ViPsVoidHistLinDiscConfiguration : IEntityTypeConfiguration<ViPsVoidHistLinDisc>
    {
        public void Configure(EntityTypeBuilder<ViPsVoidHistLinDisc> builder)
        {
            builder.ToView("VI_PS_VOID_HIST_LIN_DISC", "dbo");
            builder.HasNoKey();
