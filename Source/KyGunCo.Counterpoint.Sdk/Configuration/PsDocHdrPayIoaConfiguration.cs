...
{
    // PS_DOC_HDR_PAY_IOA
    public class PsDocHdrPayIoaConfiguration : IEntityTypeConfiguration<PsDocHdrPayIoa>
    {
        public void Configure(EntityTypeBuilder<PsDocHdrPayIoa> builder)
        {
            builder.ToTable("PS_DOC_HDR_PAY_IOA", "dbo");
            builder.HasKey(x => x.DocId).HasName("PK_PS_DOC_HDR_PAY_IOA").IsClustered();
            ...
            // Foreign keys
            builder.HasOne(a => a.PsDocHdr).WithOne(b => b.PsDocHdrPayIoa).HasForeignKey<PsDocHdrPayIoa>(c => c.DocId).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_PS_DOC_HDR_PAY_IOA_PS_DOC_HDR");
        }
    }
