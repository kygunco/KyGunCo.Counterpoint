...
{
    // VI_IM_XFER_OUT_CELL
    public class ViImXferOutCellConfiguration : IEntityTypeConfiguration<ViImXferOutCell>
    {
        public void Configure(EntityTypeBuilder<ViImXferOutCell> builder)
        {
            builder.ToView("VI_IM_XFER_OUT_CELL", "dbo");
            builder.HasNoKey();
