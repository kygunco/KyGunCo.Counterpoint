...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViPsVoidHistDiscRcptConfiguration : IEntityTypeConfiguration<ViPsVoidHistDiscRcpt>
    {
        public void Configure(EntityTypeBuilder<ViPsVoidHistDiscRcpt> builder)
        {
            builder.ToView("VI_PS_VOID_HIST_DISC_RCPT", "dbo");
            builder.HasNoKey();
