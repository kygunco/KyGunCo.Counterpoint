...
{
    // VI_INV_HIST_CELL
    public class ViInvHistCellConfiguration : IEntityTypeConfiguration<ViInvHistCell>
    {
        public void Configure(EntityTypeBuilder<ViInvHistCell> builder)
        {
            builder.ToView("VI_INV_HIST_CELL", "dbo");
            builder.HasNoKey();
