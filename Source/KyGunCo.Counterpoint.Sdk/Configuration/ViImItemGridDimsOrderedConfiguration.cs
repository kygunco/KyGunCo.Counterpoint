...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViImItemGridDimsOrderedConfiguration : IEntityTypeConfiguration<ViImItemGridDimsOrdered>
    {
        public void Configure(EntityTypeBuilder<ViImItemGridDimsOrdered> builder)
        {
            builder.ToView("VI_IM_ITEM_GRID_DIMS_ORDERED", "dbo");
            builder.HasNoKey();
