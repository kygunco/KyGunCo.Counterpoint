...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViPoVendWithAddressConfiguration : IEntityTypeConfiguration<ViPoVendWithAddress>
    {
        public void Configure(EntityTypeBuilder<ViPoVendWithAddress> builder)
        {
            builder.ToView("VI_PO_VEND_WITH_ADDRESS", "dbo");
            builder.HasNoKey();
            ...
            builder.Property(x => x.VendFstLstNam).HasColumnName(@"VEND_FST_LST_NAM").HasColumnType("varchar(42)").IsRequired(false).IsUnicode(false).HasMaxLength(42);
