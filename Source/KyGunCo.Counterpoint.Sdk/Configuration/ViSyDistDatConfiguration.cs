...
{
    // VI_SY_DIST_DAT
    public class ViSyDistDatConfiguration : IEntityTypeConfiguration<ViSyDistDat>
    {
        public void Configure(EntityTypeBuilder<ViSyDistDat> builder)
        {
            builder.ToView("VI_SY_DIST_DAT", "dbo");
            builder.HasNoKey();
