...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ImXferInHistCellConfiguration : IEntityTypeConfiguration<ImXferInHistCell>
    {
        public void Configure(EntityTypeBuilder<ImXferInHistCell> builder)
        {
            builder.ToTable("IM_XFER_IN_HIST_CELL", "dbo");
            builder.HasKey(x => new { x.EventNo, x.XferNo, x.XferInLinSeqNo, x.Dim1Upr, x.Dim2Upr, x.Dim3Upr }).HasName("PK_IM_XFER_IN_HIST_CELL").IsClustered();
            ...
            // Foreign keys
            builder.HasOne(a => a.ImXferInHistLin).WithMany(b => b.ImXferInHistCells).HasForeignKey(c => new { c.EventNo, c.XferNo, c.XferInLinSeqNo }).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_IM_XFER_IN_HIST_CELL_IM_XFER_IN_HIST_LIN");
        }
    }
