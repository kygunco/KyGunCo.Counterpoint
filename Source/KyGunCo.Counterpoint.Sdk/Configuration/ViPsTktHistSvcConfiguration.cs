...
{
    // VI_PS_TKT_HIST_SVC
    public class ViPsTktHistSvcConfiguration : IEntityTypeConfiguration<ViPsTktHistSvc>
    {
        public void Configure(EntityTypeBuilder<ViPsTktHistSvc> builder)
        {
            builder.ToView("VI_PS_TKT_HIST_SVC", "dbo");
            builder.HasNoKey();
