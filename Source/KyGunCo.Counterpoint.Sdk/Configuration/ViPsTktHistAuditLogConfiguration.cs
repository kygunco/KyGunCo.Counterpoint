...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViPsTktHistAuditLogConfiguration : IEntityTypeConfiguration<ViPsTktHistAuditLog>
    {
        public void Configure(EntityTypeBuilder<ViPsTktHistAuditLog> builder)
        {
            builder.ToView("VI_PS_TKT_HIST_AUDIT_LOG", "dbo");
            builder.HasNoKey();
