...
{
    // VI_PS_ORD_HIST_LIN_DISC_RCPT
    public class ViPsOrdHistLinDiscRcptConfiguration : IEntityTypeConfiguration<ViPsOrdHistLinDiscRcpt>
    {
        public void Configure(EntityTypeBuilder<ViPsOrdHistLinDiscRcpt> builder)
        {
            builder.ToView("VI_PS_ORD_HIST_LIN_DISC_RCPT", "dbo");
            builder.HasNoKey();
