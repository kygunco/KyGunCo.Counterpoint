...
{
    // RS_DEL_IM_ITEM
    public class RsDelImItemConfiguration : IEntityTypeConfiguration<RsDelImItem>
    {
        public void Configure(EntityTypeBuilder<RsDelImItem> builder)
        {
            builder.ToTable("RS_DEL_IM_ITEM", "dbo");
            builder.HasKey(x => x.DelId).HasName("PK_RS_DEL_IM_ITEM").IsClustered();
