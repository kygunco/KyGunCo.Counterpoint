...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class RsDelSyShipViaCodConfiguration : IEntityTypeConfiguration<RsDelSyShipViaCod>
    {
        public void Configure(EntityTypeBuilder<RsDelSyShipViaCod> builder)
        {
            builder.ToTable("RS_DEL_SY_SHIP_VIA_COD", "dbo");
            builder.HasKey(x => x.DelId).HasName("PK_RS_DEL_SY_SHIP_VIA_COD").IsClustered();
