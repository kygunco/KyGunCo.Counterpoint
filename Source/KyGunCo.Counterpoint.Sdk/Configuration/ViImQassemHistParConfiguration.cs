...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class ViImQassemHistParConfiguration : IEntityTypeConfiguration<ViImQassemHistPar>
    {
        public void Configure(EntityTypeBuilder<ViImQassemHistPar> builder)
        {
            builder.ToView("VI_IM_QASSEM_HIST_PAR", "dbo");
            builder.HasNoKey();
