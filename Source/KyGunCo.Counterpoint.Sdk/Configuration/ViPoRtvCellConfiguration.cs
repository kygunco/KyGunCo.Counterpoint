...
{
    // VI_PO_RTV_CELL
    public class ViPoRtvCellConfiguration : IEntityTypeConfiguration<ViPoRtvCell>
    {
        public void Configure(EntityTypeBuilder<ViPoRtvCell> builder)
        {
            builder.ToView("VI_PO_RTV_CELL", "dbo");
            builder.HasNoKey();
