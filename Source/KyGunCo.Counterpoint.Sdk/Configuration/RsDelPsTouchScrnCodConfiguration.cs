...
namespace KyGunCo.Counterpoint.Sdk.Configuration
{
    ...
    public class RsDelPsTouchScrnCodConfiguration : IEntityTypeConfiguration<RsDelPsTouchScrnCod>
    {
        public void Configure(EntityTypeBuilder<RsDelPsTouchScrnCod> builder)
        {
            builder.ToTable("RS_DEL_PS_TOUCH_SCRN_COD", "dbo");
            builder.HasKey(x => x.DelId).HasName("PK_RS_DEL_PS_TOUCH_SCRN_COD").IsClustered();
